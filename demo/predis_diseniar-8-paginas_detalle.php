...
$result_flyer=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='contratapa' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url2="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag2' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url3="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag3' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url4="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag4' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url5="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag5' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url6="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag6' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url7="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag7' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
                ...
                <div id="pagina-detalle">
                    <div class="col-lg-offset-0 col-md-offset-1 col-lg-12 col-md-11 col-xs-12">
                        <div id="wrap-detalle" class="col-lg-6 col-md-9 col-xs-12">
                            ...
                            <form action="predis_diseniar-8-paginas_confirmar.php" method="post" id="detalle-pedido" name="detalle-pedido" class="col-xs-12">
                                <?php
                                    $fecha = date('Y-m-j');
                                                    ...
                                                    /** * Verifica que una fecha esté dentro del rango de fechas establecidas * @param $start_date fecha de inicio * @param $end_date fecha final * @param $evaluame fecha a comparar * @return true si esta en el rango, false si no lo está */ function check_in_range($start_date, $end_date, $evaluame) { 
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <select class="form-control" name="select_cantidad" id="select_cantidad" required>
                                                                ...
                                                                <?php
                                                                $result_precios=mysql_query("select * from tabla_precios WHERE tipo='8' order by cantidad ASC");
