 ...
 <script type="text/javascript">
    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            <?php
            if (!isset($_SESSION{"predis_contratapa_8_".$_SESSION['ESTADO']})) {
                if ($niveluser!='operador') {
                    $result_esta=mysql_query("select * from rating_productos WHERE cara='contratapa' and tipo='8' AND actual='si' and predisenio='si'");
                    if($row_esta=mysql_fetch_array($result_esta)){
                        $delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='contratapa' and tipo='8' AND actual='si' and predisenio='si'");
                    }
                }
                if ($niveluser=='operador') {
                    $result_esta=mysql_query("select * from rating_productos WHERE cara='contratapa' and tipo='8' AND actual='si' and usuario='$usuario'");
                    if($row_esta=mysql_fetch_array($result_esta)){
                        $delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='contratapa' and tipo='8' AND actual='si'");
                    }
                }
            ...
            if (isset($_SESSION{"predis_pag2_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_pag3_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_pag4_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_pag5_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_pag6_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_pag7_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_contratapa_8_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"predis_contratapa_8_".$_SESSION['ESTADO']}; ?>';
                ...
                $.ajax({
                       ...
                       success: function(data)
                       {
                           ...
                           $("#flyercontainer .aramis").html('<?php echo($row_dir['cod_aramis']);?>');
                           long = $( "#flyercontainer .completed" ).length;
                            if (long > 0) {
                            ...
                            ?>
                                    $.ajax({
                                       type: "POST",
                                       dataType: "html",
                                       url: "predis_sucursales.php", 
                                       success: function(data) {
                                           $('.banner-predisenio').addClass('direccion');
                                           $(".direccion").removeClass('banner-predisenio'); 
                                           $('.direccion').html(data);
                                       },
                                        error: function(data) {
                                             return false;
            ...
            $(".guardar").click(function(e) {
                    ...
                    if (isset($_SESSION{"predis_archivo_contratapa_8_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"predis_archivo_contratapa_8_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                    var name = '<?php echo("flyer/html/FLYER_CONTRATAPA_8_".date('m-d-Y_hia').".html"); ?>';
                    <?php 
                    }
                    ?>
            ...
            $(".continuar").click(function(e) {
                    ...
                    var valUno = $('#flyercontainer #direccion_elegir_1').val();
                    if (valUno=='') {
                        hayerror = 1;
                    ...
                    if (hayerror == 0) {
                        ...
                        $('#flyercontainer .cajaproducto .descripcion strong').each(function () {
                            if ($(this).text() == '') {
                                $(this).remove();
                            }
                        });
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#cargando').fadeOut();
                                    window.location.href = "predis_diseniar-8-paginas_1.php";
                                }
                        });
                    }
            });
            ...
            var addSuc = 2;
            $('#flyercontainer').on('click', '#block-direcciones #agregarsuc', function() { 
                var VisibleSuc = $(".direccion_elegir:visible").length;
                var TotalSuc = $(".direccion_elegir").length;
                if (addSuc>6) {
                    swal("Error", "Podés agregar hasta seis (6) sucursales en la revista.", "error");
                    return false;
                }
                        ...
                        <div id="lateral" class="lateral col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-right">
                            <div class="row">
                                <div class="editar_partes">
                                    <ul>
                                        <li><a id="ed_tapa" class="disabled" href="predis_diseniar-8-paginas.php" title="EDITAR TAPA">TAPA</a></li>
                                        <li><a id="ed_contratapa" class="disabled activada" href="predis_diseniar-8-paginas_contratapa.php" title="EDITAR CONTRATAPA">CONTRATAPA</a></li>
                                ...
                                <div id="flyercontainer">
                                    <div id="contratapa" class="wrap-flyer">
                                        ...
                                        <div id="block-direcciones" class="col-xs-12">
                                                ...
                                                <div class="txtder col-xs-6 pull-left text-right">www.tumarca.com.ar</div>
                                                <?php 
                                                if ($niveluser=='operador'){
                                                ?>
                                                <div class="direccion">
                                                ...
                                                if ($niveluser!='operador') {
                                                ?>
                                                <div class="banner-predisenio"><img src="flyer/predisenio.jpg" width="794" height="199" alt=""></div>
                                                <?php     
                                                }
                                                ?>
                                        </div>
