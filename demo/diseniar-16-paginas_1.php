...
?>
<?php
    $result_traecantidad=mysql_query("select * from banners_flyer WHERE cara='pag2' AND mes='$mesbanner'");
    $valor = 0;
    $valortotal = 0;
    $maximoprod = 12;
...
// CONSULTA BLOQUEO DE MARCAS
    $result_bloqueo=mysql_query("select marca, cantidad, nombre, logo from bloqueo INNER JOIN marcas ON marcas.Id=bloqueo.marca WHERE cara='pag2' order by fecha desc");
?>
    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"pag2_".$_SESSION['ESTADO']})) {
                $result_esta=mysql_query("select * from rating_productos WHERE usuario='$usuario' and cara='pag2' and tipo='16' and actual='si'");
                if($row_esta=mysql_fetch_array($result_esta)){
                    $delete_esta=mysql_query("DELETE FROM rating_productos WHERE usuario='$usuario' and cara='pag2' and tipo='16' and actual='si'");
                }
            }
            ...
            if (isset($_SESSION{"pag2_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"pag2_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_pag2').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
                       url: "recuperarpag2.php",
                       data: {
                            'content': content
                        },
                       success: function(data)
            ...
            $(".guardar").click(function(e) {
                    ...
                    <?php 
                    if (isset($_SESSION{"archivo_pag2_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"archivo_pag2_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                    var name = '<?php echo("flyer/html/FLYER_PAG2_".date('m-d-Y_hia').".html"); ?>';
                    <?php 
                    }
                    ?>
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    ...
                                    window.location.href = "diseniar-16-paginas_2.php";
                                }
                        });
                    }
            });
                ...
                do {
                    if ($i <=$maximoprod){
                        ...
                        for ($j = 1; $j <= $cant_bloqueo; $j++) {
                            if (($j==1) && ($i==1)) {
                            ?>
                            var cuantosBloq = $('.bloqueado').length; 
                            var totBloq = $('.cajaproducto').length;
	   ...
	   <div class="inner-content">
		<!-- header-starts -->
           ...
           <div class="col-xs-12 titulogris">
                <p class="col-xs-12"><img src="images/titulos/diseniar.png" class="img-responsive" alt=""> DISEÑAR - Editando P&Aacute;GINA 2</p>
            </div>
			<!-- Diseniar start-->
                            ...
                            <div class="row">
                                <div class="editar_partes paginas16">
                                    <ul>
                                        ...
                                        <li><a id="ed_2" class="disabled activada" href="diseniar-16-paginas_1.php" title="EDITAR PAGINA 2"><strong>2</strong></a></li>
                                ...
                                <div id="flyercontainer">
                                    <div id="pag2" class="wrap-flyer">
                                        ...
                                        <div class="grupoproductos col-xs-12">
                                            ...
                                            <div class="row separador-central" id="separador-1"></div>
                                            ...
                                            <div class="row separador-central" id="separador-2"></div>
                                            ...
                                            <div class="row separador-central" id="separador-3"></div>
                                        ...
                                        <div class="bordebottom" id="end"><div class="logopie"><span>2</span></div><div class="legalespie">Los precios contado son v&aacute;lidos en efectivo, tarjeta de d&eacute;bito &oacute; tarjeta de cr&eacute;dito en 1 pago. Consulte por otros planes de financiaci&oacute;n. </div></div>
