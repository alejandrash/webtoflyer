    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"tapa_".$_SESSION['ESTADO']})) {
                $result_esta=mysql_query("select * from rating_productos WHERE usuario='$usuario' and cara='tapa' and tipo='16' and actual='si'");
                if($row_esta=mysql_fetch_array($result_esta)){
                    //$delete_esta=mysql_query("DELETE FROM rating_productos WHERE usuario='$usuario' and cara='tapa' and tipo='16' and actual='si'");
                }
            }
            if (isset($_SESSION{"contratapa_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_contratapa').removeClass('disabled');
            <?php } 
            if (isset($_SESSION{"pag2_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_2').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag3_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_3').removeClass('disabled');
            <?php } 
            if (isset($_SESSION{"pag4_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_4').removeClass('disabled');
            <?php } 
            if (isset($_SESSION{"pag5_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_5').removeClass('disabled');
            <?php } 
            if (isset($_SESSION{"pag6_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_6').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag7_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_7').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag8_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_8').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag9_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_9').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag10_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_10').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag11_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_11').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag12_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_12').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag13_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_13').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag14_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_14').removeClass('disabled');
            <?php }
            if (isset($_SESSION{"pag15_".$_SESSION['ESTADO']})) { ?>
                $('.editar_partes #ed_15').removeClass('disabled');
            <?php }
            
            if (isset($_SESSION{"tapa_".$_SESSION['ESTADO']})) { ?>
            
                var content = '<?php $_SESSION{"tapa_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_tapa').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
                       url: "recuperartapa.php",
                       data: {
                            'content': content
                        },
                       success: function(data)
            ...
            $(".guardar").click(function(e) {
                    ...
                    if (isset($_SESSION{"archivo_tapa_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"archivo_tapa_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    ...
                                    window.location.href = "diseniar-16-paginas_contratapa.php";
                                }
                        });
                    }
            });
                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div id="lateral" class="lateral col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-right">
                            <div class="row">
                                <div class="editar_partes paginas16">
                                    <ul>
                                        <li><a id="ed_tapa" class="disabled activada" href="diseniar-16-paginas.php" title="EDITAR TAPA">TAPA</a></li>
                                        <li><a id="ed_contratapa" class="disabled" href="diseniar-16-paginas_contratapa.php" title="EDITAR CONTRATAPA">CONTRATAPA</a></li>
                                        <li><a id="ed_2" class="disabled" href="diseniar-16-paginas_1.php" title="EDITAR PAGINA 2"><strong>2</strong></a></li>
                                        <li><a id="ed_3" class="disabled" href="diseniar-16-paginas_2.php" title="EDITAR PAGINA 3"><strong>3</strong></a></li>
                                        <li><a id="ed_4" class="disabled" href="diseniar-16-paginas_3.php" title="EDITAR PAGINA 4"><strong>4</strong></a></li>
                                        <li><a id="ed_5" class="disabled" href="diseniar-16-paginas_4.php" title="EDITAR PAGINA 5"><strong>5</strong></a></li>
                                        <li><a id="ed_6" class="disabled" href="diseniar-16-paginas_5.php" title="EDITAR PAGINA 6"><strong>6</strong></a></li>
                                        <li><a id="ed_7" class="disabled" href="diseniar-16-paginas_6.php" title="EDITAR PAGINA 7"><strong>7</strong></a></li>
                                        <li><a id="ed_8" class="disabled" href="diseniar-16-paginas_7.php" title="EDITAR PAGINA 8"><strong>8</strong></a></li>
                                        <li><a id="ed_9" class="disabled" href="diseniar-16-paginas_8.php" title="EDITAR PAGINA 9"><strong>9</strong></a></li>
                                        <li><a id="ed_10" class="disabled" href="diseniar-16-paginas_9.php" title="EDITAR PAGINA 10"><strong>10</strong></a></li>
                                        <li><a id="ed_11" class="disabled" href="diseniar-16-paginas_10.php" title="EDITAR PAGINA 11"><strong>11</strong></a></li>
                                        <li><a id="ed_12" class="disabled" href="diseniar-16-paginas_11.php" title="EDITAR PAGINA 12"><strong>12</strong></a></li>
                                        <li><a id="ed_13" class="disabled" href="diseniar-16-paginas_12.php" title="EDITAR PAGINA 13"><strong>13</strong></a></li>
                                        <li><a id="ed_14" class="disabled" href="diseniar-16-paginas_13.php" title="EDITAR PAGINA 14"><strong>14</strong></a></li>
                                        <li><a id="ed_15" class="disabled" href="diseniar-16-paginas_14.php" title="EDITAR PAGINA 15"><strong>15</strong></a></li>
                                    </ul>
                    ...
                    <?php
                       /*VERIFICO SY TIENE FLYER SIN TERMINAR */
                        $hay = 0;
                        $result_fly=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='tapa' and terminado='no' ORDER BY Id DESC LIMIT 1");
                        ...
                        if ($hay == 1) {
                            if (($row_fly['id_sesion']!=$id_sesion) || (!isset($_SESSION{"tapa_".$_SESSION['ESTADO']}))) {
                                ...
                                <?php
                                    echo('<div id="wrap-enviado" class="col-lg-8 col-md-8 col-sm-9 col-xs-12 eleccion"><br><br><br><br><p class="titulo-pico">Dejaste un flyer sin terminar desde tu &uacute;ltima conexi&oacute;n a WTF.</p><br><br> <a class="btn col-xs-3 col-xs-offset-2" href="diseniar-16-paginas.php?contin=si" title="Click aqui para continuar el diseño"><img src="images/continuardis.jpg" class="img-responsive out" alt=""><img src="images/continuardis_over.jpg" class="img-responsive over" alt=""></a> <a class="comenzar btn col-xs-offset-2 col-xs-3" title="Click aqui para comenzar un nuevo diseño de flyer" href="diseniar-16-paginas.php?nuevo=si"><img src="images/nuevodis.jpg" class="img-responsive out" alt=""><img src="images/nuevodis_over.jpg" class="img-responsive over" alt=""></a></div>');
                                }
                                if (isset($_GET['nuevo'])) {
                                    $result_fly=mysql_query("DELETE from flyers WHERE tipo='16' and usuario='$usuario' AND terminado='no'");
                                    $result_esta=mysql_query("select * from rating_productos WHERE usuario='$usuario' and tipo='16' and actual='si'");
                                   if ($row_esta=mysql_fetch_array($result_esta))
                                   {
                                        do {
                                           $id = $row_esta['Id'];
                                           ...
                                           if ($orden == 0) {
                                                ...
                                                $result=mysql_query("UPDATE rating_productos set actual='no' WHERE usuario='$usuario' and tipo='16'") or die(mysql_error());
                                           }
                                        } while ($row_esta=mysql_fetch_array($result_esta));
                                    }
                                    header("Location:diseniar-16-paginas.php");
                                ...
                                if (isset($_GET['contin'])) {
                                    ...
                                    //TAPA
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='tapa' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $_SESSION['SESIONFLY']=$id_sesion_old;
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"tapa_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_tapa_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    }
                                    //CONTRATAPA
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='contratapa' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"contratapa_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_contratapa_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_contratapa').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 2
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag2' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag2_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag2_".$_SESSION['ESTADO']} = $row_fly_otros['url']; 
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_2').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 3
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag3' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag3_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag3_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_3').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 4
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag4' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag4_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag4_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_4').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 5
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag5' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag5_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag5_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_5').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 6
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag6' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag6_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag6_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_6').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 7
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag7' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag7_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag7_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_7').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 8
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag8' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag8_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag8_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_8').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 9
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag9' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag9_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag9_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_9').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 10
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag10' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag10_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag10_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_10').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 11
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag11' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag11_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag11_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_11').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 12
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag12' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag12_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag12_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_12').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 13
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag13' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag13_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag13_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_13').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 14
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag14' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag14_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag14_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_14').removeClass('disabled');
                                        </script>
                                    ...
                                    //PAGINA 15
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16' and usuario='$usuario' and cara='pag15' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"pag15_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_pag15_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_15').removeClass('disabled');
                                        </script>
