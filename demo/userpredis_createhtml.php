...
if($cara == "tapa"){
    $_SESSION{"predis_tapa_8_".$_SESSION['ESTADO']} =$sesion;
    $_SESSION{"predis_archivo_tapa_8_".$_SESSION['ESTADO']} =$name;
}
if($cara == "contratapa"){
    $_SESSION{"predis_contratapa_8_".$_SESSION['ESTADO']} =$sesion;
    $_SESSION{"predis_archivo_contratapa_8_".$_SESSION['ESTADO']} =$name;
}
if($cara == "pag2"){
    $_SESSION{"predis_pag2_8_".$_SESSION['ESTADO']} =$sesion;
    $_SESSION{"predis_archivo_pag2_8_".$_SESSION['ESTADO']} =$name;
}
if($cara == "pag3"){
    $_SESSION{"predis_pag3_8_".$_SESSION['ESTADO']} =$sesion;
    $_SESSION{"predis_archivo_pag3_8_".$_SESSION['ESTADO']} =$name;
}
if($cara == "pag4"){
    $_SESSION{"predis_pag4_8_".$_SESSION['ESTADO']} =$sesion;
    $_SESSION{"predis_archivo_pag4_8_".$_SESSION['ESTADO']} =$name;
}
if($cara == "pag5"){
    $_SESSION{"predis_pag5_8_".$_SESSION['ESTADO']} =$sesion;
    $_SESSION{"predis_archivo_pag5_8_".$_SESSION['ESTADO']} =$name;
}
if($cara == "pag6"){
    $_SESSION{"predis_pag6_8_".$_SESSION['ESTADO']} =$sesion;
    $_SESSION{"predis_archivo_pag6_8_".$_SESSION['ESTADO']} =$name;
}
if($cara == "pag7"){
    $_SESSION{"predis_pag7_8_".$_SESSION['ESTADO']} =$sesion;
    $_SESSION{"predis_archivo_pag7_8_".$_SESSION['ESTADO']} =$name;
}
...
if($row_existe=mysql_fetch_array($result_existe)){
    ...
    $result=mysql_query("INSERT INTO flyers (id_sesion, fecha, usuario, url, grabado, cara, tipo) VALUES ('$id_sesion', '$fecha', '$usuario', '$name', '$sesion', '$cara', '8predis')") or die(mysql_error());
}
print_r($_POST);
?>