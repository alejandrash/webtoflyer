...
if ($usuario == 'alehusson@yahoo.com/demo.ar') {
    $cantidad2 = 0;
}
...
$result_flyer=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='tapa' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url1="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer_contratapa=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='contratapa' AND terminado='no' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_contratapa=mysql_fetch_array($result_flyer_contratapa))
{
    $url2="http://webtoflyer.com/demo/".$row_flyer_contratapa["url"];
}
$result_flyer_pag2=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag2' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag2=mysql_fetch_array($result_flyer_pag2))
{
    $url3="http://webtoflyer.com/demo/".$row_flyer_pag2["url"];
}
$result_flyer_pag3=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag3' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag3=mysql_fetch_array($result_flyer_pag3))
{
    $url4="http://webtoflyer.com/demo/".$row_flyer_pag3["url"];
}
$result_flyer_pag4=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag4' AND terminado='no' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag4=mysql_fetch_array($result_flyer_pag4))
{
    $url5="http://webtoflyer.com/demo/".$row_flyer_pag4["url"];
}
$result_flyer_pag5=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag5' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag5=mysql_fetch_array($result_flyer_pag5))
{
    $url6="http://webtoflyer.com/demo/".$row_flyer_pag5["url"];
}
$result_flyer_pag6=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag6' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag6=mysql_fetch_array($result_flyer_pag6))
{
    $url7="http://webtoflyer.com/demo/".$row_flyer_pag6["url"];
}
$result_flyer_pag7=mysql_query("select * from flyers WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag7' ORDER BY Id DESC LIMIT 1");
...
//$urlcli1 = "http://api.pagelr.com/demo/capture/javascript?".$file1;
//$urlcli2 = "http://api.pagelr.com/demo/capture/javascript?".$file2;
//$urlcli3 = "http://api.pagelr.com/demo/capture/javascript?".$file3;
//$urlcli4 = "http://api.pagelr.com/demo/capture/javascript?".$file4;
//$urlcli5 = "http://api.pagelr.com/demo/capture/javascript?".$file5;
//$urlcli6 = "http://api.pagelr.com/demo/capture/javascript?".$file6;
//$urlcli7 = "http://api.pagelr.com/demo/capture/javascript?".$file7;
//$urlcli8 = "http://api.pagelr.com/demo/capture/javascript?".$file8;

$urlcli1="http://do.convertapi.com/demo/Web2Image?OutputFileName=TAPA_predis_8".$id_sesion."&curl=".$url1."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli2="http://do.convertapi.com/demo/Web2Image?OutputFileName=CONTRATAPA_predis_8".$id_sesion."&curl=".$url2."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli3="http://do.convertapi.com/demo/Web2Image?OutputFileName=PAG2_predis_8".$id_sesion."&curl=".$url3."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli4="http://do.convertapi.com/demo/Web2Image?OutputFileName=PAG3_predis_8".$id_sesion."&curl=".$url4."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli5="http://do.convertapi.com/demo/Web2Image?OutputFileName=PAG4_predis_8".$id_sesion."&curl=".$url5."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli6="http://do.convertapi.com/demo/Web2Image?OutputFileName=PAG5_predis_8".$id_sesion."&curl=".$url6."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli7="http://do.convertapi.com/demo/Web2Image?OutputFileName=PAG6_predis_8".$id_sesion."&curl=".$url7."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli8="http://do.convertapi.com/demo/Web2Image?OutputFileName=PAG7_predis_8".$id_sesion."&curl=".$url8."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
...
$url1 = "http://api.pdflayer.com/demo/api/convert?access_key=64fed91fc5157e21bb8cca93fdbf18ff&document_url=".$url1."&secret_key=".$md5hash1."&page_size=A4&margin_top=0&margin_bottom=0&margin_left=0&margin_right=0&dpi=1000&ttl=300&force=1&document_name=TAPA_8_".$aramis."_".$nro_orden.".pdf";

$url2 = "http://api.pdflayer.com/demo/api/convert?access_key=64fed91fc5157e21bb8cca93fdbf18ff&document_url=".$url2."&secret_key=".$md5hash2."&page_size=A4&margin_top=0&margin_bottom=0&margin_left=0&margin_right=0&dpi=1000&ttl=300&force=1&document_name=CONTRATAPA_8_".$aramis."_".$nro_orden.".pdf";

$url3 = "http://api.pdflayer.com/demo/api/convert?access_key=64fed91fc5157e21bb8cca93fdbf18ff&document_url=".$url3."&secret_key=".$md5hash3."&page_size=A4&margin_top=0&margin_bottom=0&margin_left=0&margin_right=0&dpi=1000&ttl=300&force=1&document_name=PAG2_8_".$aramis."_".$nro_orden.".pdf";

$url4 = "http://api.pdflayer.com/demo/api/convert?access_key=64fed91fc5157e21bb8cca93fdbf18ff&document_url=".$url4."&secret_key=".$md5hash4."&page_size=A4&margin_top=0&margin_bottom=0&margin_left=0&margin_right=0&dpi=1000&ttl=300&force=1&document_name=PAG3_8_".$aramis."_".$nro_orden.".pdf";

$url5 = "http://api.pdflayer.com/demo/api/convert?access_key=64fed91fc5157e21bb8cca93fdbf18ff&document_url=".$url5."&secret_key=".$md5hash5."&page_size=A4&margin_top=0&margin_bottom=0&margin_left=0&margin_right=0&dpi=1000&ttl=300&force=1&document_name=PAG4_8_".$aramis."_".$nro_orden.".pdf";

$url6 = "http://api.pdflayer.com/demo/api/convert?access_key=64fed91fc5157e21bb8cca93fdbf18ff&document_url=".$url6."&secret_key=".$md5hash6."&page_size=A4&margin_top=0&margin_bottom=0&margin_left=0&margin_right=0&dpi=1000&ttl=300&force=1&document_name=PAG5_8_".$aramis."_".$nro_orden.".pdf";
$url7 = "http://api.pdflayer.com/demo/api/convert?access_key=64fed91fc5157e21bb8cca93fdbf18ff&document_url=".$url7."&secret_key=".$md5hash7."&page_size=A4&margin_top=0&margin_bottom=0&margin_left=0&margin_right=0&dpi=1000&ttl=300&force=1&document_name=PAG6_8_".$aramis."_".$nro_orden.".pdf";
$url8 = "http://api.pdflayer.com/demo/api/convert?access_key=64fed91fc5157e21bb8cca93fdbf18ff&document_url=".$url8."&secret_key=".$md5hash8."&page_size=A4&margin_top=0&margin_bottom=0&margin_left=0&margin_right=0&dpi=1000&ttl=300&force=1&document_name=PAG7_8_".$aramis."_".$nro_orden.".pdf";


$update_orden_tapa=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='8predis' AND usuario ='$usuario' AND cara='tapa' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_contratapa=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='8predis' AND usuario ='$usuario' AND cara='contratapa' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intizq=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag2' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag3' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag4' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag5' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag6' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='8predis' AND usuario ='$usuario' AND cara='pag7' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
...
/* MAIL A IDG */
		...
		$mail->Host = "localhost";
		$mail->From = "sistema@webtoflyer.com/demo";
		$mail->FromName = "WTF";
		$mail->Timeout=30;
		$mail->Subject = $aramis." - ".$nro_orden." - Solicitud nueva Revista(8) Predisenada WEB TO FLYER";
        $mail->AddAddress("ruben@idgonline.com/demo.ar");
        $mail->AddCC('jorgelina@idgonline.com/demo.ar');
...
/* MAIL A MARQUEZ - WEBMASTER */
        ...
        $mailmar->From = "sistema@webtoflyer.com/demo";
        $mailmar->FromName = "WTF";
        $mailmar->Timeout=30;
        $mailmar->Subject = $aramis." - ".$nro_orden." - Solicitud nueva Revista (8) Predisenada WEB TO FLYER";
...
/* MAIL AL CLIENTE */
        ...
        $mailcli->From = "sistema@webtoflyer.com/demo";
        $mailcli->FromName = "WTF";
        $mailcli->Timeout=30;
        $mailcli->Subject = $aramis." - ".$nro_orden." - Solicitud nueva Revista(8) Predisenada WEB TO FLYER";
...
header("Location:predis_diseniar-8_enviado.php");
//print_r($_POST);
?>