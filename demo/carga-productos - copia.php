            ...
            <div class="wrapper-prod-general">
                ...
                <div class="wrap-productos col-lg-10 col-md-12 col-xs-12">
                    ...
                    <div class="content-form col-xs-12">
                            ...
                            <form class="form-inline" action="insertarprod_procesar.php" method="post" id="insertarprod" name="insertarprod" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                            ...
                                            echo("<p class='error' style='width:72%; display:inline-block;'>No hay marcas, debe cargar una antes de cargar productos.</p>");
                                            ?>
                                            <script type="text/javascript">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="modelo" name="modelo" maxlength="18" required>
                                    <p class="small">Escribe el modelo de tu producto. <strong>Por ejemplo: <u>WA10J6750LP</u></strong></p>
                                </div>
                                <div class="form-group">
                                    <label for="descripcion">DESCRIPCI&Oacute;N</label>
                                    <textarea class="form-control" id="descripcion" name="descripcion" maxlength="120" required></textarea>
                                    <p class="small">Coloc&aacute; las caracter&iacute;sticas m&aacute;s importantes del producto evitando repetir informaci&oacute;n.</p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="origen">PA&Iacute;S DE ORIGEN</label>
                                    <select class="form-control" id="origen" name="origen" required>
                                        <option value="">Seleccione el pa&iacute;s de origen</option>
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <p class="small"><strong><u>Requisitos</u>: Formato de imagen JPG/PNG, Resoluci&oacute;n 300dpi, Colores RGB. Imagen con fondo blanco. Dimensiones: Alto 4.8cm, Ancho 9.45cm, Tama&ntilde;o aprox 600 kb</strong><br>En el caso de no contar con las herramientas necesarias para cumplir los requisitos puede solicitar ayuda mediante el soporte t&eacute;cnico.</p>
                                    <div class="fotowrap">
                                ...
                                <div class="form-group">
                                    <label for="titulo">PRECIO EN $</label>
                                    <input type="text" class="form-control" id="precio" name="precio" value="$0,00" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="tags">PALABRAS DE B&Uacute;SQUEDA</label>
                                    <input type="text" class="form-control" id="tags" name="tags" value="" data-role="tagsinput" placeholder="heladera, freezer, no frost">
                                    <p class="small"><strong>Escrib&iacute; las palabras clave separadas por una coma (luego servir&aacute;n para encontrar el producto).</strong></p>
                                </div>
                        ...
                        <?php 
                            if ($niveluser != 'operador') {
                                $result_pr=mysql_query("select productos.Id AS id_prod, id_cat, id_marca, titulo, modelo, descripcion, sucursal, foto, precio, origen, productos.usuario AS usuario_prod, tags from productos INNER JOIN usuarios ON productos.usuario=usuarios.email ORDER BY productos.Id, titulo ASC");
                            }
                            if ($niveluser == 'operador') {
                                $result_pr=mysql_query("select productos.Id AS id_prod, id_cat, id_marca, titulo, modelo, descripcion, sucursal, foto, precio, origen, productos.usuario AS usuario_prod, tags from productos INNER JOIN usuarios ON productos.usuario=usuarios.email WHERE productos.usuario='$user' ORDER BY productos.Id, titulo ASC");
                            }
                        ...
                        <form action="eliminarprod_procesar.php" method="post" id="administrarprod" name="administrarprod">
                            <table border="0" cellpadding="0" cellspacing="0" class="dataTable" id="tablaResultados">
                                ...
                                <tr class="<?php echo $stilo?>">
                                    ...
                                    <td><a href="modificarprod.php?id_pub=<?php echo $row_pr['id_prod']?>"><img src="images/iconito-modificar.png" title="Modificar"></a></td>
                                    <td><?php echo ($row_pr['id_prod'])?></td>
                                    <td><?php echo htmlspecialchars($row_pr['titulo'])?></td>
