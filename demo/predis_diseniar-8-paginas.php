...
session_set_cookie_params(21600,"/"); 
	...
	if ($niveluser == 'operador') {
        $urlRenueva = "renuevarating.php";
        $urlCreate = "userpredis_createhtml.php";
        $urlGuarda = "guardarating.php";
    }
    else {
        $urlRenueva = "predis_renuevarating.php";
        $urlCreate = "predis_createhtml.php";
        $urlGuarda = "predis_guardarating.php";
    }
?>
<?php 
//FECHA para cabecera
 ...
 <script type="text/javascript"> 
    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            <?php
            if (!isset($_SESSION{"predis_tapa_8_".$_SESSION['ESTADO']})) {
            	if ($niveluser!='operador') {
	                $result_esta=mysql_query("select * from rating_productos WHERE cara='tapa' and tipo='8' AND actual='si' and predisenio='si'");
	                if($row_esta=mysql_fetch_array($result_esta)){
	                    //$delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='tapa' and tipo='8' AND actual='si' and predisenio='si'");
	                }
            	}
            	if ($niveluser=='operador') {
	                $result_esta=mysql_query("select * from rating_productos WHERE cara='tapa' and tipo='8' AND actual='si' and usuario='$usuario'");
	                if($row_esta=mysql_fetch_array($result_esta)){
	                    //$delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='tapa' and tipo='8' AND actual='si'");
	                }
            	}
            }
            if (isset($_SESSION{"predis_archivo_contratapa_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag2_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag3_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?>  
            ...
            if (isset($_SESSION{"predis_archivo_pag4_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag5_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag6_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag7_8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_tapa_8_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"predis_tapa_8_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_tapa').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
                       url: "predis_recuperartapa_8.php",
                       data: {
                            'content': content
                        },
                       success: function(data)
                       {
                           ...
                           $("#flyercontainer .aramis").html('<?php echo($row_user['cod_aramis']);?>');
                           long = $( "#flyercontainer .completed" ).length;
                            if (long > 0) {
            ...
            $(".guardar").click(function(e) {
                    ...
                    <?php 
                    if (isset($_SESSION{"predis_archivo_tapa_8_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"predis_archivo_tapa_8_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
            ...
            $(".continuar").click(function(e) {
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#cargando').fadeOut();
                                    window.location.href = "predis_diseniar-8-paginas_contratapa.php";
                                }
                        });
                    }
            });
                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div id="lateral" class="lateral col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-right">
                            <div class="row">
                                <div class="editar_partes">
                                    <ul>
                                        <li><a id="ed_tapa" class="disabled activada" href="predis_diseniar-8-paginas.php" title="EDITAR TAPA">TAPA</a></li>
                                        <li><a id="ed_contratapa" class="disabled" href="predis_diseniar-8-paginas_contratapa.php" title="EDITAR CONTRATAPA">CONTRATAPA</a></li>
                                        <li><a id="ed_2" class="disabled" href="predis_diseniar-8-paginas_1.php" title="EDITAR PAGINA 2"><strong>2</strong></a></li>
                                        <li><a id="ed_3" class="disabled" href="predis_diseniar-8-paginas_2.php" title="EDITAR PAGINA 3"><strong>3</strong></a></li>
                                        <li><a id="ed_4" class="disabled" href="predis_diseniar-8-paginas_3.php" title="EDITAR PAGINA 4"><strong>4</strong></a></li>
                                        <li><a id="ed_5" class="disabled" href="predis_diseniar-8-paginas_4.php" title="EDITAR PAGINA 5"><strong>5</strong></a></li>
                                        <li><a id="ed_6" class="disabled" href="predis_diseniar-8-paginas_5.php" title="EDITAR PAGINA 6"><strong>6</strong></a></li>
                                        <li><a id="ed_7" class="disabled" href="predis_diseniar-8-paginas_6.php" title="EDITAR PAGINA 7"><strong>7</strong></a></li>
                                    </ul>
                    ...
                    <?php
                       /*VERIFICO SY TIENE FLYER SIN TERMINAR */
                        ...
                        /* CASA CENTRAL Y IDG */
                        if ($niveluser!='operador') {
	                        $result_fly=mysql_query("select * from predisenio WHERE tipo='8' and cara='tapa' ORDER BY Id DESC LIMIT 1");
	                        ...
	                        if ($hay == 1) {
	                            if (($row_fly['id_sesion']!=$id_sesion) || (!isset($_SESSION{"predis_tapa_8_".$_SESSION['ESTADO']}))) {
	                                ...
	                                <?php
	                                    echo('<div id="wrap-enviado" class="col-lg-8 col-md-8 col-sm-9 col-xs-12 eleccion"><br><br><br><br><p class="">El diseño de la revista prediseñada ya esta empezado y/o terminado. Queres modificarlo y/o continuarlo?</p><br><br> <a class="btn col-xs-3 col-xs-offset-2" href="predis_diseniar-8-paginas.php?contin=si" title="Click aqui para continuar el diseño"><img src="images/continuardis.jpg" class="img-responsive out" alt=""><img src="images/continuardis_over.jpg" class="img-responsive over" alt=""></a> <a class="comenzar btn col-xs-offset-2 col-xs-3" title="Click aqui para comenzar un nuevo diseño de revista" href="predis_diseniar-8-paginas.php?nuevo=si"><img src="images/nuevodis.jpg" class="img-responsive out" alt=""><img src="images/nuevodis_over.jpg" class="img-responsive over" alt=""></a></div>');
	                                }
	                                if (isset($_GET['nuevo'])) {
	                                    $result_fly=mysql_query("DELETE from predisenio WHERE tipo='8'");
	                                    $result_esta=mysql_query("select * from rating_productos WHERE tipo='8' and actual='si' AND predisenio='si'");
	                                   if ($row_esta=mysql_fetch_array($result_esta))
	                                   {
	                                        do {
	                                           $id = $row_esta['Id'];
	                                           ...
	                                           if ($orden == 0) {
	                                                ...
	                                                $result=mysql_query("UPDATE rating_productos set actual='no' WHERE tipo='8' AND predisenio='si'") or die(mysql_error());
	                                           }
	                                        } while ($row_esta=mysql_fetch_array($result_esta));
	                                    }
	                                    header("Location:predis_diseniar-8-paginas.php");
                                    ?>
                                        <script type="text/javascript">
                                            $(document).ready(function () {
	                                ...
	                                if (isset($_GET['contin'])) {
	                                    ...
	                                    //TAPA
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and cara='tapa' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $_SESSION['SESIONFLY']=$id_sesion_old;
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_tapa_8_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_tapa_8_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
	                                    }
	                                    //CONTRATAPA
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and cara='contratapa' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_contratapa_8_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_contratapa_8_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_contratapa').removeClass('disabled');
	                                    ...
	                                    //PAGINA 2
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and cara='pag2' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag2_8_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag2_8_".$_SESSION['ESTADO']} = $row_fly_otros['url']; 
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_2').removeClass('disabled');
	                                    ...
	                                    //PAGINA 3
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and cara='pag3' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag3_8_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag3_8_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_3').removeClass('disabled');
	                                    ...
	                                    //PAGINA 4
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and cara='pag4' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag4_8_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag4_8_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_4').removeClass('disabled');
	                                    ...
	                                    //PAGINA 5
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and cara='pag5' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag5_8_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag5_8_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_5').removeClass('disabled');
	                                    ...
	                                    //PAGINA 6
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and cara='pag6' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag6_8_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag6_8_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_6').removeClass('disabled');
	                                    ...
	                                    //PAGINA 7
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and cara='pag7' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag7_8_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag7_8_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_7').removeClass('disabled');
                   		...
                   		/* USUARIOS SOCIOS */
                   		if ($niveluser=='operador') {
                   			$result_fly=mysql_query("select * from flyers WHERE tipo='8predis' and cara='tapa' and terminado='no' and usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                   			$id_sesion = $_SESSION['SESIONFLY'];
	                        if ($row_fly=mysql_fetch_array($result_fly)) {
	                            $hay = 1;
	                        }
	                        ...
	                        if ($hay == 1) {
	                            if (($row_fly['id_sesion']!=$id_sesion) || (!isset($_SESSION{"predis_tapa_8_".$_SESSION['ESTADO']}))) {
	                                ...
	                                <?php
	                                    echo('<div id="wrap-enviado" class="col-lg-8 col-md-8 col-sm-9 col-xs-12 eleccion"><br><br><br><br><p class="titulo-pico">Dejaste una revista prediseñada sin terminar desde tu &uacute;ltima conexi&oacute;n a WTF.</p><br><br> <a class="btn col-xs-3 col-xs-offset-2" href="predis_diseniar-8-paginas.php?contin=si" title="Click aqui para continuar el diseño"><img src="images/continuardis.jpg" class="img-responsive out" alt=""><img src="images/continuardis_over.jpg" class="img-responsive over" alt=""></a> <a class="comenzar btn col-xs-offset-2 col-xs-3" title="Click aqui para comenzar un nuevo diseño de revista" href="predis_diseniar-8-paginas.php?nuevo=si"><img src="images/nuevodis.jpg" class="img-responsive out" alt=""><img src="images/nuevodis_over.jpg" class="img-responsive over" alt=""></a></div>');
	                                }
	                                if (isset($_GET['nuevo'])) {
	                                    $result_fly=mysql_query("DELETE from flyers WHERE tipo='8predis' and usuario='$usuario' and terminado='no'");
	                                    $result_esta=mysql_query("select * from rating_productos WHERE tipo='8' and actual='si' AND usuario='$usuario'");
	                                   if ($row_esta=mysql_fetch_array($result_esta))
	                                   {
	                                        do {
	                                           $id = $row_esta['Id'];
	                                           ...
	                                           if ($orden == 0) {
	                                                ...
	                                                $result=mysql_query("UPDATE rating_productos set actual='no' WHERE tipo='8' AND usuario='$usuario'") or die(mysql_error());
	                                           }
	                                        } while ($row_esta=mysql_fetch_array($result_esta));
	                                    }
	                                    header("Location:predis_diseniar-8-paginas.php");
	                                ...
	                                if (isset($_GET['contin'])) {
                                        ...
                                        <?php
	                                    //TAPA
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='8predis' and cara='tapa' and terminado='no' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $_SESSION['SESIONFLY']=$id_sesion_old;
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and cara='tapa' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_tapa_8_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_tapa_8_".$_SESSION['ESTADO']} = $html; 
                                            }
                                        }
	                                    //CONTRATAPA
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='8predis' and terminado='no' and cara='contratapa' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_contratapa_8_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and terminado='no' and cara='contratapa' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_contratapa_8_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_contratapa_8_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 2
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='8predis' and terminado='no' and cara='pag2' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag2_8_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and terminado='no' and cara='pag2' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag2_8_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag2_8_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 3
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='8predis' and terminado='no' and cara='pag3' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag3_8_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and terminado='no' and cara='pag3' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag3_8_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag3_8_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 4
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='8predis' and terminado='no' and cara='pag4' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag4_8_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and terminado='no' and cara='pag4' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag4_8_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag4_8_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 5
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='8predis' and terminado='no' and cara='pag5' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag5_8_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and terminado='no' and cara='pag5' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag5_8_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag5_8_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 6
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='8predis' and terminado='no' and cara='pag6' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag6_8_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and terminado='no' and cara='pag6' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag6_8_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag6_8_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 7
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='8predis' and terminado='no' and cara='pag7' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag7_8_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='8' and terminado='no' and cara='pag7' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag7_8_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag7_8_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }
	                                ?>
		                        ...
		                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            ...
                                            <script type="text/javascript">
                                                    ...
                                                    $.ajax({
                                                       ...
                                                       url: "predis_recuperartapa_8.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_tapa_8_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                                           $("#editor2").html(data); 
                                                           $("#editor2 .aramis, #editor .aramis").html('<?php echo($row_user['cod_aramis']);?>');
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperar_contratapa_8.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_contratapa_8_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag2_8.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag2_8_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag3_8.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag3_8_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag4_8.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag4_8_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag5_8.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag5_8_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
		                                    ...
		                                    ?>
		                                        <script type="text/javascript"> 
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag6_8.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag6_8_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag7_8.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag7_8_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
