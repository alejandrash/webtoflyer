                ...
                <div class="wrap-productos col-lg-10 col-md-12 col-xs-12">
                    ...
                    <div class="ordenar-por col-xs-12">
                        <div class="row">
                            <ul>
                                <li>Ordenar por:</li>
                                <li>// <a class="active" href="productos-inner.php?id_cat=<?php echo($id_cat);?>&query=id">carga reciente</a></li>
                                <li>// <a href="productos-inner.php?id_cat=<?php echo($id_cat);?>&query=marca">marca</a></li>
                            </ul>
                        </div></ul>
                    </div>
                    ...
                    <div class="slider-paginacion" id="carousel-pag">
                        ...
                        <div class="paginacion" style="top:0; padding:5px 5px 15px 5px;">
                            ...
                            if ($total_paginas > 1) {
                               ...
                               if ($pagina != 1) 
                                  echo '<a href="productos-inner.php?id_cat='.$id_cat.'&query='.$query.'&pagina='.($pagina-1).'">&laquo;</a>';
                                  for ($i=1;$i<=$total_paginas;$i++) {
                                     if ($pagina == $i)
                                        ...
                                        echo '  <a href="productos-inner.php?id_cat='.$id_cat.'&query='.$query.'&pagina='.$i.'">'.$i.'</a>  ';
                                  }
                                  if ($pagina != $total_paginas)
                                     echo '<a href="productos-inner.php?id_cat='.$id_cat.'&query='.$query.'&pagina='.($pagina+1).'">&raquo;</a>';
                            }
                            ?>
                        </div>
