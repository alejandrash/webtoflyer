...
$update_orden_tapa=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND cara='tapa' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_contratapa=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='contratapa' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intizq=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag2' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag3' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag4' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag5' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag6' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag7' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag8' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag9' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag10' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag11' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag12' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag13' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag14' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
$update_orden_intder=mysql_query("UPDATE flyers SET nro_orden='$nro_orden', terminado='si' WHERE tipo='16' AND usuario ='$usuario' AND id_sesion='$id_sesion' AND cara='pag15' ORDER BY Id DESC LIMIT 1") or die(mysql_error());
...
$result_borrar=mysql_query("DELETE from flyers WHERE terminado='no' AND tipo='16' AND usuario ='$usuario' AND cara='tapa'")  or die(mysql_error());
...
$result_flyer_contratapa=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='contratapa' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_contratapa=mysql_fetch_array($result_flyer_contratapa))
{
    $url2="http://webtoflyer.com/".$row_flyer_contratapa["url"];
}
$result_flyer_pag2=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag2' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag2=mysql_fetch_array($result_flyer_pag2))
{
    $url3="http://webtoflyer.com/".$row_flyer_pag2["url"];
}
$result_flyer_pag3=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag3' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag3=mysql_fetch_array($result_flyer_pag3))
{
    $url4="http://webtoflyer.com/".$row_flyer_pag3["url"];
}
$result_flyer_pag4=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag4' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag4=mysql_fetch_array($result_flyer_pag4))
{
    $url5="http://webtoflyer.com/".$row_flyer_pag4["url"];
}
$result_flyer_pag5=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag5' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag5=mysql_fetch_array($result_flyer_pag5))
{
    $url6="http://webtoflyer.com/".$row_flyer_pag5["url"];
}
$result_flyer_pag6=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag6' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag6=mysql_fetch_array($result_flyer_pag6))
{
    $url7="http://webtoflyer.com/".$row_flyer_pag6["url"];
}
$result_flyer_pag7=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag7' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag7=mysql_fetch_array($result_flyer_pag7))
{
    $url8="http://webtoflyer.com/".$row_flyer_pag7["url"];
}
$result_flyer_pag8=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag8' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag8=mysql_fetch_array($result_flyer_pag8))
{
    $url9="http://webtoflyer.com/".$row_flyer_pag8["url"];
}
$result_flyer_pag9=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag9' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag9=mysql_fetch_array($result_flyer_pag9))
{
    $url10="http://webtoflyer.com/".$row_flyer_pag9["url"];
}
$result_flyer_pag10=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag10' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag10=mysql_fetch_array($result_flyer_pag10))
{
    $url11="http://webtoflyer.com/".$row_flyer_pag10["url"];
}
$result_flyer_pag11=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag11' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag11=mysql_fetch_array($result_flyer_pag11))
{
    $url12="http://webtoflyer.com/".$row_flyer_pag11["url"];
}
$result_flyer_pag12=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag12' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag12=mysql_fetch_array($result_flyer_pag12))
{
    $url13="http://webtoflyer.com/".$row_flyer_pag12["url"];
}
$result_flyer_pag13=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag13' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag13=mysql_fetch_array($result_flyer_pag13))
{
    $url14="http://webtoflyer.com/".$row_flyer_pag13["url"];
}
$result_flyer_pag14=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag14' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag14=mysql_fetch_array($result_flyer_pag14))
{
    $url15="http://webtoflyer.com/".$row_flyer_pag14["url"];
}
$result_flyer_pag15=mysql_query("select * from flyers WHERE tipo='16' AND usuario ='$usuario' AND cara='pag15' ORDER BY Id DESC LIMIT 1");
if ($row_flyer_pag15=mysql_fetch_array($result_flyer_pag15))
{
    $url16="http://webtoflyer.com/".$row_flyer_pag15["url"];
}
...
/* MAIL A IDG */
		...
		$mail->FromName = "WTF";
		$mail->Timeout=30;
		$mail->Subject = $aramis." - ".$nro_orden." - Solicitud nueva Revista(16) WEB TO FLYER";
		...
		$body  = "<table width='600' style='font-family: Verdana; font-size:12px;'><tr><td><img src='http://webtoflyer.com/mails/header.jpg'></td></tr><tr><td style='padding:0 25px;'>Buen d&iacute;a, <br>Se ha generado una nueva solicitud de impresi&oacute;n. Les dejamos los datos a continuaci&oacute;n: </h3><br>Haga click en los 4 enlaces inferiores para descargar los PDF.<br><br>";
...
/* MAIL A MARQUEZ - WEBMASTER */
        ...
        $mailmar->Timeout=30;
        $mailmar->Subject = $aramis." - ".$nro_orden." - Solicitud nueva Revista (16) WEB TO FLYER";
        $mailmar->AddAddress("info@webtoflyer.com","WTF");
        $mailmar->AddCC('alehusson@gmail.com');
        
        $bodymar  = "<table width='600' style='font-family: Verdana; font-size:12px;'><tr><td><img src='http://webtoflyer.com/mails/header.jpg'></td></tr><tr><td style='padding:0 25px;'>Estimados, <br>Se ha generado una nueva solicitud de impresi&oacute;n. Les dejamos los datos a continuaci&oacute;n:<br><br>";
        ...
        $bodymar .= "</td></tr><tr><td><img src='http://webtoflyer.com/mails/footer.jpg'></td></tr></table>";
...
/* MAIL AL CLIENTE */
		...
		$mailcli->Timeout=30;
		$mailcli->Subject = $aramis." - ".$nro_orden." - Solicitud nueva Revista(16) WEB TO FLYER";

        $mailcli->AddAddress($email,$nombre);
        $mailcli->AddBCC('alehusson@gmail.com');
		if ($cantidad < 10000) {
    		$bodycli  = "<table width='600' style='font-family: Verdana; font-size:12px;'><tr><td><img src='http://webtoflyer.com/mails/header.jpg'></td></tr><tr><td style='padding:0 25px;'>Hola ".$nombre."! <br>Hiciste un nuevo pedido de impresi&oacute;n de revistas. <br>Tu diseno fue enviado a impresion y en unos dias llegara a tu local. <br>Por cualquier duda llamanos al 4871-8184, o chate&aacute; con nosotros ingresando a WTF. Muchas gracias.<br><br>Te dejamos una copia de todos los datos a continuaci&oacute;n: <br><br>";
            ...
            $bodycli  = "<table width='600' style='font-family: Verdana; font-size:12px;'><tr><td><img src='http://webtoflyer.com/mails/header.jpg'></td></tr><tr><td style='padding:0 25px;'>Hola ".$nombre."! <br>Hiciste un nuevo pedido de impresi&oacute;n de revistas. <br>Lo revisaremos para asegurarnos que sea optimo para impresion y en las siguientes horas te enviaremos los archivos para que des tu aprobacion final. <br>Por cualquier duda llamanos al 4871-8184, o chate&aacute; con nosotros ingresando a WTF. Muchas gracias.<br><br>Te dejamos una copia de todos los datos a continuaci&oacute;n: <br><br>";
            $bodycli .= "<strong>NRO DE REFERENCIA: </strong> ".$nro_orden."<br /><br>";
            $bodycli .= "<strong>CANTIDAD DE REVISTAS: </strong> ".$cantidad."<br /><br>";
            $bodycli .= "<strong>MONTO A CARGAR Cta.: </strong> $".$precio." + IVA<br /><br>";
            $bodycli .= "<strong>SEMANA ESTIMADA DE ENTREGA: </strong> ".$estimado."<br /><br>";
...
header("Location:diseniar-16_enviado.php");
//echo($bodycli);
//print_r($_POST);
?>