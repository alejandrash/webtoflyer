	   ...
	   <div class="inner-content">
		<!-- header-starts -->
            ...
            <div class="col-xs-12 titulogris">
                <p class="col-xs-12"><img src="images/titulos/diseniar.png" class="img-responsive" alt=""> DISEÑAR - Finalización de Pedido</p>
            </div>
			<!-- Diseniar start-->
                ...
                <div id="pagina-conf">
                    <div class="col-lg-offset-1 col-lg-11 col-md-12 col-xs-12">
                        <div id="wrap-detalle" class="col-lg-6 col-md-9 col-xs-12">
                            <form action="predis_detalle-16_procesar.php" method="post" id="confirmar-pedido" name="confirmar-pedido" class="col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="form-group noborder">
                                        ...
                                        <input type="hidden" id="prov" name="prov" value="<?php echo(utf8_encode($prov)); ?>">
