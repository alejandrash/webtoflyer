    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"predis_pag4_8_".$_SESSION['ESTADO']})) {
                if ($niveluser!='operador') {
                    $result_esta=mysql_query("select * from rating_productos WHERE cara='pag4' and tipo='8' AND actual='si' and predisenio='si'");
                    if($row_esta=mysql_fetch_array($result_esta)){
                        $delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='pag4' and tipo='8' AND actual='si' and predisenio='si'");
                    }
                }
                if ($niveluser=='operador') {
                    $result_esta=mysql_query("select * from rating_productos WHERE cara='pag4' and tipo='8' AND actual='si' and usuario='$usuario'");
                    if($row_esta=mysql_fetch_array($result_esta)){
                        $delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='pag4' and tipo='8' AND actual='si'");
                    }
                }
            }
            ...
            if (isset($_SESSION{"predis_pag4_8_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"predis_pag4_8_".$_SESSION['ESTADO']}; ?>';
            ...
            $(".guardar").click(function(e) { 
                    ...
                    if (isset($_SESSION{"predis_archivo_pag4_8_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"predis_archivo_pag4_8_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                    var name = '<?php echo("flyer/html/FLYER_PAG4_8_".date('m-d-Y_hia').".html"); ?>';
                    <?php 
                    }
                    ?>
            ...
            $(".continuar").click(function(e) {
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#cargando').fadeOut();
                                    window.location.href = "predis_diseniar-8-paginas_4.php";
                                }
                        });
                    }
                    return false;
                            ...
                            <div class="row">
                                <div class="editar_partes">
                                    <ul>
                                        ...
                                        <li><a id="ed_4" class="disabled activada" href="predis_diseniar-8-paginas_3.php" title="EDITAR PAGINA 4"><strong>4</strong></a></li>
