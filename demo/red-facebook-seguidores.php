...
function Convert() {
        convertParameter = "storefile=true&PageNo=true&PageWidth=495&PageHeight=500&JpgQuality=100";
            ...
            if (data.Result == true) {
                ...
                var ruta = data.FileUrl;
                                ...
                                success: function(data2) { 
                                    ...
                                    //window.open(urlcompartir,'ventanacompartir', 'toolbar=0, status=0, width=650, height=650');
                                    $("#enlace").attr('href',urlcompartir);
                                    var evt = document.createEvent("MouseEvents");
                                      evt.initMouseEvent("click", true, true, window,
                                        0, 0, 0, 0, 0, false, false, false, false, 0, null);
                                      var a = document.getElementById("enlace"); 
                                      urlwhatsapp = "https://api.whatsapp.com/send?text="+data2+"";
                                      a.dispatchEvent(evt); 
                                        setTimeout(
                                          function() 
                                          {
