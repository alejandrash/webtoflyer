		...
		<!-- header-starts -->
            ...
            <div class="wrapper-prod-general">
                ...
                <div class="botonera-acciones col-lg-2 col-md-12 col-xs-12">
                    <ul>
                        <li class="active"><a href="carga-promos.php">INSERTAR PROMO</a></li>
                        <?php
                        if ($niveluser != 'operador') { ?>
                        <li class="secundarias"><a href="#tablaMarcas">&bull; ADMINISTRAR PROMOS</a></li>
                        <?php }
                        ?>
                    </ul>
                </div>
                ...
                <div class="wrap-productos col-lg-10 col-md-12 col-xs-12">
                    ...
                    <div class="titular col-xs-12">
                        <h1>CARGA DE PROMOS</h1>
                        <ul>
                            <li class="active"><a href="#">Insertar Promo</a></li>
                            <?php
                            if ($niveluser != 'operador') { ?>
                            <li><a href="#tablaMarcas">Administrar Promos</a></li>
                            <?php }
                            ?>
                        </ul>
                    </div>
                    ...
                    <div class="content-form col-xs-12">
                        <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 col-xs-offset-0 col-xs-12" style="margin-bottom:50px;">
                            ...
                            <?php } ?>
                            <form class="form-inline" action="insertarpromo_procesar.php" method="post" id="insertarpromo" name="insertarpromo" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="form-group text-right">
                                    <label for="foto">JPG de la Promo</label>
                                    <input type="file" class="form-control" id="foto" name="foto" accept="image/*" data-id="">
                                    <p class="small"><strong><u>Requisitos</u>: Formato de imagen JPG, Resoluci&oacute;n 300dpi, Colores RGB<br>Dimensiones: Ancho 9.45cm, Alto 0.96cm</strong></p>
                                    <div class="fotowrap">
                        ...
                        <?php 
                            $result_pr=mysql_query("select * from promos ORDER BY Id DESC");
                            if ($row_pr=mysql_fetch_array($result_pr))
                            {
                        ?>
                        
                        <!--START TABLA RESULTADOS-->
                        <form action="eliminarpromo_procesar.php" method="post" id="administrarpromo" name="administrarpromo">
                        ...
                        <?php
                                ...
                                echo("<p class='col-xs-12 error text-center'><br><br>No hay promos disponibles.</p>");
                            }
                        ?>
                    </div>
                    <!-- Form end-->
