						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
                                        ...
                                        <li><a href="redes.php" title="Redes"><i class="fa fa-share-alt" aria-hidden="true"></i> <span>Redes Sociales</span></a></li>
                                        <li><a href="editar-plantilla-general.php" title="Redes"><i class="fa fa-cog" aria-hidden="true"></i> <span>Editar Redes</span></a></li>
