            ...
            <div class="wrapper-prod-general">
                ...
                <div class="wrap-container col-lg-10 col-md-12 col-xs-12">
                    ...
                    <div class="titular col-xs-12">
                        <h1 style="background:none; position:relative;"><i class="fa fa-cloud-download" style="font-size:1.5em; position:absolute; left:0;" aria-hidden="true"></i> DESCARGA DE MATERIAL GRATUITO OFICIAL</h1>
                        <ul>
                            <li><a href="descargar-material.php">Gr&aacute;fica</a></li>
                            <li class="active"><a href="descargar-material2.php">Multimedia</a></li>
                        </ul>
                    </div>
                    <!-- Titular end-->
                    ...
                    <div class="content-form col-xs-12">
                        ...
                        <?php 
                            $result_pr=mysql_query("select * from material WHERE tipo='Multimedia' ORDER BY Id DESC");
                            if ($row_pr=mysql_fetch_array($result_pr))
                            {
                        ?>
                        <h2>MATERIAL DE MULTIMEDIA</h2>
                        ...
                        <?php
                                ...
                                echo("<p class='col-xs-12 error text-center'>No hay material disponible.</p>");
                            }
                        ?>
                </div>
                <!-- Estadisticas ends-->
