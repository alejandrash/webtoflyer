...
<tr>
<td><span class="smaller" style="display:none;"><a href="<?php echo $hesk_settings['site_url']; ?>" class="smaller"><?php echo $hesk_settings['site_title']; ?></a> &gt;
...
<tr>
<td width="3"></td>
<td class="headersm"><?php echo("Soporte T&eacute;cnico");//hesk_showTopBar($hesk_settings['hesk_title']); ?></td>
<td width="3"></td>
</tr>
</table>
...
else
{
	...
	{
		?>
		<p style="text-align:center; display:none;"><a href="<?php echo $hesk_settings['admin_dir']; ?>/" class="smaller"><?php echo $hesklang['ap']; ?></a></p>
		<?php
	}
