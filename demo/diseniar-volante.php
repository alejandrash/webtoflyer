    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"frente_".$_SESSION['ESTADO']})) {
                $result_esta=mysql_query("select * from rating_productos WHERE usuario='$usuario' and cara='frente' and tipo='2' and actual='si'");
                if($row_esta=mysql_fetch_array($result_esta)){
                    //$delete_esta=mysql_query("DELETE FROM rating_productos WHERE usuario='$usuario' and cara='frente' and tipo='2' and actual='si'");
                }
            }
            ...
            if (isset($_SESSION{"frente_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"frente_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_tapa').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
                       url: "recuperarfrente.php",
                       data: {
                            'content': content
                        },
                       success: function(data)
            ...
            $(".guardar").click(function(e) {
                    ...
                    <?php 
                    if (isset($_SESSION{"archivo_frente_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"archivo_frente_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                    var name = '<?php echo("flyer/html/FLYER_FRENTE_".date('m-d-Y_hia').".html"); ?>';
                    <?php 
                    }
                    ?>
            ...
            $(".continuar").click(function(e) {
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#cargando').fadeOut();
                                    window.location.href = "diseniar-volante_dorso.php";
                                }
                        });
                    }
            });
	   ...
	   <div class="inner-content">
		<!-- header-starts -->
           ...
           <div class="col-xs-12 titulogris">
                <p class="col-xs-12"><img src="images/titulos/diseniar.png" class="img-responsive" alt=""> DISEÑAR - Editando Frente</p>
            </div>
           <?php 
                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div id="lateral" class="lateral col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-right">
                            <div class="row">
                                <div class="editar_partes">
                                    <ul>
                                        <li style="display: inline-block; float:none!important; margin-right: 0!important;"><a id="ed_tapa" class="disabled activada" href="diseniar-volante.php" title="EDITAR FRENTE">FRENTE</a></li>
                                        <li style="display: inline-block; float:none!important; margin-right: 0!important;"><a id="ed_contratapa" class="disabled" href="diseniar-volante_dorso.php" title="EDITAR DORSO">DORSO</a></li>
                                    </ul>
                    ...
                    <?php
                       /*VERIFICO SY TIENE FLYER SIN TERMINAR */
                        $hay = 0;
                        $result_fly=mysql_query("select * from flyers WHERE tipo='2' and usuario='$usuario' and cara='frente' and terminado='no' ORDER BY Id DESC LIMIT 1");
                        ...
                        if ($hay == 1) {
                            if (($row_fly['id_sesion']!=$id_sesion) || (!isset($_SESSION{"frente_".$_SESSION['ESTADO']}))) {
                                ...
                                <?php
                                    echo('<div id="wrap-enviado" class="col-lg-8 col-md-8 col-sm-9 col-xs-12 eleccion"><br><br><br><br><p class="titulo-pico">Dejaste un flyer sin terminar desde tu &uacute;ltima conexi&oacute;n a WTF.</p><br><br> <a class="btn col-xs-3 col-xs-offset-2" href="diseniar-volante.php?contin=si" title="Click aqui para continuar el diseño"><img src="images/continuardis.jpg" class="img-responsive out" alt=""><img src="images/continuardis_over.jpg" class="img-responsive over" alt=""></a> <a class="comenzar btn col-xs-offset-2 col-xs-3" title="Click aqui para comenzar un nuevo diseño de flyer" href="diseniar-volante.php?nuevo=si"><img src="images/nuevodis.jpg" class="img-responsive out" alt=""><img src="images/nuevodis_over.jpg" class="img-responsive over" alt=""></a></div>');
                                }
                                if (isset($_GET['nuevo'])) {
                                    $result_fly=mysql_query("DELETE from flyers WHERE tipo='2' and usuario='$usuario' and id_sesion!='$id_sesion' AND terminado='no'");
                                    $result_esta=mysql_query("select * from rating_productos WHERE usuario='$usuario' and tipo='2' and actual='si'");
                                   if ($row_esta=mysql_fetch_array($result_esta))
                                   {
                                        do {
                                           $id = $row_esta['Id'];
                                           ...
                                           if ($orden == 0) {
                                                ...
                                                $result=mysql_query("UPDATE rating_productos set actual='no' WHERE usuario='$usuario' and tipo='2'") or die(mysql_error());
                                           }
                                        } while ($row_esta=mysql_fetch_array($result_esta));
                                    }
                                    header("Location:diseniar-volante.php");
                                ...
                                <div id="flyercontainer">
                                    <div id="frente" class="wrap-flyer">
                                ...
                                if (isset($_GET['contin'])) { 
                                    ...
                                    $id_sesion = $id_sesion_old;
                                    $_SESSION['SESIONFLY'] = $row_fly['id_sesion'];

                                    //TAPA
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='2' and usuario='$usuario' and cara='frente' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $_SESSION['SESIONFLY']=$id_sesion_old;
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"frente_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_frente_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    }
                                    //CONTRATAPA
                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='2' and usuario='$usuario' and cara='dorso' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                        $html = $row_fly_otros['grabado'];
                                        $html=str_replace("*","'",$html);
                                        $_SESSION{"dorso_".$_SESSION['ESTADO']} = $html;
                                        $_SESSION{"archivo_dorso_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                    ?>
                                        <script type="text/javascript">
                                            $('.editar_partes #ed_contratapa').removeClass('disabled');
                                        </script>
