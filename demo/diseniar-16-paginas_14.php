    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"pag15_".$_SESSION['ESTADO']})) {
                $result_esta=mysql_query("select * from rating_productos WHERE usuario='$usuario' and cara='pag15' and tipo='16' and actual='si'");
                if($row_esta=mysql_fetch_array($result_esta)){
                    $delete_esta=mysql_query("DELETE FROM rating_productos WHERE usuario='$usuario' and cara='pag15' and tipo='16' and actual='si'");
                }
            }
            ...
            if (isset($_SESSION{"pag15_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"pag15_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_pag15').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
                       url: "recuperarpag15.php",
                       data: {
                            'content': content
                        },
                       success: function(data)
            ...
            $(".guardar").click(function(e) { 
                    ...
                    <?php 
                    if (isset($_SESSION{"archivo_pag15_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"archivo_pag15_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                            ...
                            function(isConfirm) {
                                if (isConfirm) {
                                        ...
                                        $.ajax({
                                                ...
                                                success: function(data){
                                                    $('#cargando').fadeOut();
                                                    window.location.href = "diseniar-16-paginas_detalle.php";
                                                }
                                        });
                                } 
                            }
                            ...
                            <div class="row">
                                <div class="editar_partes paginas16">
                                    <ul>
                                        ...
                                        <li><a id="ed_15" class="disabled activada" href="diseniar-16-paginas_14.php" title="EDITAR PAGINA 15"><strong>15</strong></a></li>
                                    </ul>
