...
if($row_existe=mysql_fetch_array($result_existe)){
    ...
    $result=mysql_query("INSERT INTO flyers (id_sesion, fecha, usuario, url, grabado, cara, tipo) VALUES ('$id_sesion', '$fecha', '$usuario', '$name', '$sesion', '$cara', '16predis')") or die(mysql_error());
}
print_r($_POST);
?>