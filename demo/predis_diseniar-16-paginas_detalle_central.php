...
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='contratapa' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url2="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag2' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url3="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag3' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url4="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag4' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url5="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag5' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url6="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag6' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url7="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag7' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url8="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag8' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url9="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag9' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url10="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag10' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url11="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag11' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url12="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag12' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url13="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag13' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url14="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag14' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url15="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from predisenio WHERE tipo='16' AND cara='pag15' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
...
$urlcli1="http://do.convertapi.com/Web2Image?OutputFileName=TAPA_PREDISENIO_16".$id_sesion."&curl=".$url1."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli2="http://do.convertapi.com/Web2Image?OutputFileName=CONTRATAPA_PREDISENIO_16".$id_sesion."&curl=".$url2."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli3="http://do.convertapi.com/Web2Image?OutputFileName=PAG2_PREDISENIO_16".$id_sesion."&curl=".$url3."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli4="http://do.convertapi.com/Web2Image?OutputFileName=PAG3_PREDISENIO_16".$id_sesion."&curl=".$url4."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli5="http://do.convertapi.com/Web2Image?OutputFileName=PAG4_PREDISENIO_16".$id_sesion."&curl=".$url5."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli6="http://do.convertapi.com/Web2Image?OutputFileName=PAG5_PREDISENIO_16".$id_sesion."&curl=".$url6."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli7="http://do.convertapi.com/Web2Image?OutputFileName=PAG6_PREDISENIO_16".$id_sesion."&curl=".$url7."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli8="http://do.convertapi.com/Web2Image?OutputFileName=PAG7_PREDISENIO_16".$id_sesion."&curl=".$url8."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli9="http://do.convertapi.com/Web2Image?OutputFileName=PAG8_PREDISENIO_16".$id_sesion."&curl=".$url9."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli10="http://do.convertapi.com/Web2Image?OutputFileName=PAG9_PREDISENIO_16".$id_sesion."&curl=".$url10."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli11="http://do.convertapi.com/Web2Image?OutputFileName=PAG10_PREDISENIO_16".$id_sesion."&curl=".$url11."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli12="http://do.convertapi.com/Web2Image?OutputFileName=PAG11_PREDISENIO_16".$id_sesion."&curl=".$url12."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli13="http://do.convertapi.com/Web2Image?OutputFileName=PAG12_PREDISENIO_16".$id_sesion."&curl=".$url13."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli14="http://do.convertapi.com/Web2Image?OutputFileName=PAG13_PREDISENIO_16".$id_sesion."&curl=".$url14."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli15="http://do.convertapi.com/Web2Image?OutputFileName=PAG14_PREDISENIO_16".$id_sesion."&curl=".$url15."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli16="http://do.convertapi.com/Web2Image?OutputFileName=PAG15_PREDISENIO_16".$id_sesion."&curl=".$url16."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
?>
<!DOCTYPE HTML>
<html>
<head>
                ...
                <div id="pagina-detalle">
                    <div class="col-lg-offset-0 col-md-offset-1 col-lg-12 col-md-11 col-xs-12">
                        <div id="wrap-detalle" class="col-lg-6 col-md-9 col-xs-12">
                            ...
                            <form action="predis_detalle-16_procesar_central.php" method="post" id="detalle-pedido" name="detalle-pedido" class="col-xs-12">
...
<script type="text/javascript">
    ...
    $(document).ready(function () { 
        ...
        $("#cancelar").click(function() {     
                window.location.href = "predis_diseniar-16-paginas.php";
        });
    });
