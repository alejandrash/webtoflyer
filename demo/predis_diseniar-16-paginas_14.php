...
?>
<?php
    $result_traecantidad=mysql_query("select * from banners_flyer WHERE cara='pag15' AND mes='$mesbanner'");
    $valor = 0;
    $valortotal = 0;
    $maximoprod = 9;
...
// CONSULTA BLOQUEO DE MARCAS
    $result_bloqueo=mysql_query("select marca, cantidad, nombre, logo from bloqueo INNER JOIN marcas ON marcas.Id=bloqueo.marca WHERE cara='pag15' order by fecha desc");
?>
...
// TRAE LEGALES ACTUALIZADOS
    ...
    $result_predi=mysql_query("select * from predisenio WHERE tipo='16' ORDER BY Id DESC LIMIT 1");
    $row_predi=mysql_fetch_array($result_predi);
    $sesion_predisenio = $row_predi['id_sesion'];
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='tapa' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='tapa' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='contratapa' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='contratapa' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag2' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag2' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag3' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag3' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag4' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag4' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag5' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag5' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag6' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag6' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag7' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag7' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag8' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag8' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag9' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag9' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag10' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag10' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag11' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag11' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag12' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag12' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' and cara='pag13' ORDER BY Id ASC");
        if ($row_legf=mysql_fetch_array($result_legf)) {
            do { 
                if ($row_legf['legales']!=''){
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
            ...
            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND predisenio='si' AND legales!='' and cara='pag13' AND id_sesion='$sesion_predisenio' ORDER BY Id ASC");
            if ($row_legf=mysql_fetch_array($result_legf)) {
                do { 
                    $posicion_coincidencia = strpos($resultLeg, $row_legf['legales']);
                    if ($posicion_coincidencia === false) {
    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"predis_pag15_".$_SESSION['ESTADO']})) {
                if ($niveluser!='operador') {
                    $result_esta=mysql_query("select * from rating_productos WHERE cara='pag15' and tipo='16' AND actual='si' and predisenio='si'");
                    if($row_esta=mysql_fetch_array($result_esta)){
                        $delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='pag15' and tipo='16' AND actual='si' and predisenio='si'");
                    }
                }
                if ($niveluser=='operador') {
                    $result_esta=mysql_query("select * from rating_productos WHERE cara='pag15' and tipo='16' AND actual='si' and usuario='$usuario'");
                    if($row_esta=mysql_fetch_array($result_esta)){
                        $delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='pag15' and tipo='16' AND actual='si'");
                    }
                }
            }
            ...
            if (isset($_SESSION{"predis_pag15_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"predis_pag15_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_pag15').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
            ...
            $(".guardar").click(function(e) { 
                    ...
                    $("#dpd1").attr('value', FechaDesde);
                    $("#dpd2").attr('value', FechaHasta);
                    $('#cargando').fadeIn();
                    var sesion = {};
                    var flyer = {};
                    var cara = "pag15";
                    ...
                    if (isset($_SESSION{"predis_archivo_pag15_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"predis_archivo_pag15_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                    var name = '<?php echo("flyer/html/FLYER_pag15_".date('m-d-Y_hia').".html"); ?>';
                    <?php 
                    }
                    ?>
                            ...
                            if (isConfirm) {
                                    ...
                                    $.ajax({
                                            ...
                                            success: function(data){
                                                ...
                                                <?php
                                                    if ($niveluser!='operador') {
                                                        $location = "predis_diseniar-16-paginas_detalle_central.php";
                                                    }
                                                    if ($niveluser=='operador') {
                                                        $location = "predis_diseniar-16-paginas_detalle.php";
                                                    }
                                                ?>
	   ...
	   <div class="inner-content">
		<!-- header-starts -->
           ...
           <div class="col-xs-12 titulogris">
                <p class="col-xs-12"><img src="images/titulos/diseniar.png" class="img-responsive" alt=""> DISEÑAR - Editando P&Aacute;GINA 15</p>
            </div>
			<!-- Diseniar start-->
                            ...
                            <div class="row">
                                <div class="editar_partes paginas16">
                                    <ul>
                                        ...
                                        <li><a id="ed_15" class="disabled activada" href="predis_diseniar-16-paginas_14.php" title="EDITAR PAGINA 15"><strong>15</strong></a></li>
                                    </ul>
                        ...
                        <!--START FLYER-->
                                <div id="flyercontainer">
                                    <div id="pag15" class="wrap-flyer">
                                        ...
                                        <div id="container-legales">
                                                <div class="inner-legales"> 
                                                    ...
                                                    <div class="legales-financiacion">
                                                        ...
                                                        <?php
                                                            $sess = $_SESSION['SESIONFLY'];
                                                            $result_legf=mysql_query("select DISTINCT legales from rating_productos WHERE tipo='16' AND id_sesion='$sess' AND legales!='' ORDER BY Id ASC");
                                                            if ($row_legf=mysql_fetch_array($result_legf)) {
                                                                do {
                                                        ?>
                                        ...
                                        <div class="bordebottom" id="end"><div class="legalespie">Los precios contado son v&aacute;lidos en efectivo, tarjeta de d&eacute;bito &oacute; tarjeta de cr&eacute;dito en 1 pago. Consulte por otros planes de financiaci&oacute;n. </div><div class="logopie"><span>15</span></div></div>
