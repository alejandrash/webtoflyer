...
?>
<?php
    $result_traecantidad=mysql_query("select * from banners_flyer WHERE cara='pag14' AND mes='$mesbanner'");
    $valor = 0;
    $valortotal = 0;
    $maximoprod = 9;
...
// CONSULTA BLOQUEO DE MARCAS
    $result_bloqueo=mysql_query("select marca, cantidad, nombre, logo from bloqueo INNER JOIN marcas ON marcas.Id=bloqueo.marca WHERE cara='pag14' order by fecha desc");
?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"pag14_".$_SESSION['ESTADO']})) {
                $result_esta=mysql_query("select * from rating_productos WHERE usuario='$usuario' and cara='pag14' and tipo='16' and actual='si'");
                if($row_esta=mysql_fetch_array($result_esta)){
                    $delete_esta=mysql_query("DELETE FROM rating_productos WHERE usuario='$usuario' and cara='pag14' and tipo='16' and actual='si'");
                }
            }
            ...
            if (isset($_SESSION{"pag14_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"pag14_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_pag14').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
                       url: "recuperarpag14.php",
                       data: {
                            'content': content
                        },
                       success: function(data)
            ...
            $(".guardar").click(function(e) { 
                    ...
                    <?php 
                    if (isset($_SESSION{"archivo_pag14_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"archivo_pag14_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                    var name = '<?php echo("flyer/html/FLYER_pag14_".date('m-d-Y_hia').".html"); ?>';
                    <?php 
                    }
                    ?>
            ...
            $(".continuar").click(function(e) {
                    ...
                    if (controlpie == 'CLICK PARA SELECCIONAR UN BANNER...') {
                        hayerror = 1;
                        swal("Error", "Debe seleccionar un banner para la cabecera de la página.", "error");
                        $("html, body").animate({
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#cargando').fadeOut();
                                    window.location.href = "diseniar-16-paginas_14.php";
                                }
                        });
                    }
                    return false;
	   ...
	   <div class="inner-content">
		<!-- header-starts -->
           ...
           <div class="col-xs-12 titulogris">
                <p class="col-xs-12"><img src="images/titulos/diseniar.png" class="img-responsive" alt=""> DISEÑAR - Editando P&Aacute;GINA 14</p>
            </div>
			<!-- Diseniar start-->
                            ...
                            <div class="row">
                                <div class="editar_partes paginas16">
                                    <ul>
                                        ...
                                        <li><a id="ed_14" class="disabled activada" href="diseniar-16-paginas_13.php" title="EDITAR PAGINA 14"><strong>14</strong></a></li>
                        ...
                        <!--START FLYER-->
                                <div id="flyercontainer">
                                    <div id="pag14" class="wrap-flyer">
                                        ...
                                        <div class="bordebottom" id="end"><div class="logopie"><span>14</span></div><div class="legalespie">Los precios contado son v&aacute;lidos en efectivo, tarjeta de d&eacute;bito &oacute; tarjeta de cr&eacute;dito en 1 pago. Consulte por otros planes de financiaci&oacute;n. </div></div>
