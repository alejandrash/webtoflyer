...
if ($estado == 2) {
	$result_pred=mysql_query("select * from redes_predeterminados WHERE tipo='gratuita' AND Id='$idimg'");
}
if ($estado == 3) {
	$result_pred=mysql_query("select * from redes_gifs WHERE tipo='gratuita' AND Id='$idimg'");
}
