		...
		<!-- header-starts -->
            ...
            <div class="wrapper-prod-general">
                ...
                <div class="botonera-acciones col-lg-2 col-md-12 col-xs-12">
                    <ul>
                        <li class="active"><a href="#">MATERIAL GRATUITO OFICIAL</a></li>
                        <li class="secundarias"><a href="marquez-in.php">CARGAR</a></li>
                        <li class="secundarias"><a href="#tablaMarcas">ADMINISTRAR</a></li>
                        <li class="secundarias"><a href="descargar-material.php">DESCARGAR</a></li>
                    </ul>
                </div>
                ...
                <div class="wrap-container col-lg-10 col-md-12 col-xs-12">
                    ...
                    <div class="titular col-xs-12">
                        <h1>CARGA DE MATERIAL GRATUITO OFICIAL</h1>
                        <ul>
                            <li class="active"><a href="marquez-in.php">Cargar Material</a></li>
                            <li><a href="#tablaMarcas">Administrar Material</a></li>
                        </ul>
                    </div>
                    <!-- Titular end-->
                    ...
                    <div class="content-form col-xs-12">
                        <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 col-xs-offset-0 col-xs-12" style="margin-bottom:50px;">
                            ...
                            <?php } ?>
                            <form class="form-inline" action="insertarmaterial_procesar.php" method="post" id="insertarmaterial" name="insertarmaterial" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="form-group">
                                    <label for="tipo" style="width:35%;">&iquest;Qu&eacute; tipo de material va a cargar?</label>
                                    <select style="width:64%;" class="form-control" id="tipo" name="tipo">
                                        <option value="Grafica">Gr&aacute;fica</option>
                                        <option value="Multimedia">Multimedia</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="titulo" style="width:35%;">Ingrese un t&iacute;tulo para el material</label>
                                    <input style="width:64%;" type="text" class="form-control" id="titulo" name="titulo" required>
                                </div>
                                <div class="form-group text-right">
                                    <label for="foto" style="width:35%;">Archivo</label>
                                    <input style="width:64%;" type="file" class="form-control" id="foto" name="foto" accept="" data-id="">
                                </div>
                        ...
                        <?php 
                            $result_pr=mysql_query("select * from material ORDER BY Id DESC");
                            if ($row_pr=mysql_fetch_array($result_pr))
                            {
                        ?>
                        
                        <!--START TABLA RESULTADOS-->
                        <form action="eliminarmaterial_procesar.php" method="post" id="administrarpromo" name="administrarpromo">
