...
echo('<div class="interior int-pre"><div class="marca"><div class="titulo"><p>'.$row_produ['titulo'].'</p></div><div class="logo"><img src="images/'.$row_mar['logo'].'" alt=""></div><a id="'.$row_produ['Id'].'" class="quitar" href="#" title="Quitar Producto">x</a></div><div class="imagen"><img src="images/'.$row_produ['foto'].'" class="img-responsive" alt=""><div class="frases"><p class="hidden"><span>ORIGEN: </span><input class="pais" type="hidden" value="'.$row_produ['origen'].'"></p><p id="frase_stock"><span>STOCK: </span><input class="stock" onkeypress="return Onlyprices(event)" type="text" value="5"><strong> u.</strong></p></div> <div class="skin"></div><a class="selecucarda cucarda1" data-toggle="modal" href="#cucardas1" title="Click aqui para agregar cucarda"><span>ELEGIR CUCARDA</span></a>  <a class="selecucarda cucarda2" data-toggle="modal" href="#cucardas2" title="Click aqui para agregar cucarda"><span>ELEGIR CUCARDA</span></a>  </div><div class="descripcion"><p><span class="numero"></span><strong style="font-weight:normal"; placeholder="Escribe aqui la descripcion..." contenteditable="true">'.$descripcion.'</strong> Origen: '.$origen.'</p></div></div><div class="bottom"><span>PRECIO CONTADO</span><input onkeypress="return Onlyprices(event)" class="auto big" type="text" step=",01" value="'.$row_produ['precio'].'"></div>  <div class="selec-financiacion-big"><div class="mitad"><a href="#tarjetas" data-toggle="modal" class="sele seletarjetas" title="Click aqui para seleccionar tarjeta">SELECCIONAR TARJETA</a> <a data-toggle="modal" href="#bancos" class="sele selebancos disabled" title="Click aqui para seleccionar banco">SELECCIONAR BANCO</a></div>   <div class="zona-cuota"><a data-toggle="modal" href="#cuotas" class="sele selecuotas disabled" title="Click aqui para seleccionar la cantidad de cuotas">SELECCIONAR CUOTAS</a><input data-cft="" data-tea="" data-coef="" data-cuotas="" onkeypress="return Onlyprices(event)" class="auto disabled" type="text" step=",01" value="$0,00"></div> <div class="zona-valores"><div class="cft"><p>CFT: <span>0,00</span>%</p>COSTO FINANCIERO TOTAL</div><div class="right"><div class="ptf"><p>PTF: $<span>0,00</span></p></div><div class="tea"><p>TEA: <span>0,00</span>%</p></div></div> </div> </div> <div class="overlay"><i class="fa fa-minus-circle" aria-hidden="true"></i></div>');
?>