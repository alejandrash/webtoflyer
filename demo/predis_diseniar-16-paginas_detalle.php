...
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='contratapa' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url2="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag2' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url3="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag3' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url4="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag4' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url5="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag5' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url6="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag6' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url7="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag7' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url8="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag8' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url9="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag9' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url10="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag10' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url11="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag11' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url12="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag12' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url13="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag13' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url14="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag14' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url15="http://webtoflyer.com/demo/".$row_flyer["url"];
}
$result_flyer=mysql_query("select * from flyers WHERE tipo='16predis' AND usuario ='$usuario' AND cara='pag15' ORDER BY Id DESC LIMIT 1");
if ($row_flyer=mysql_fetch_array($result_flyer))
{
    $url16="http://webtoflyer.com/demo/".$row_flyer["url"];
}

$urlcli1="http://do.convertapi.com/Web2Image?OutputFileName=TAPA_predis_8".$id_sesion."&curl=".$url1."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli2="http://do.convertapi.com/Web2Image?OutputFileName=CONTRATAPA_predis_8".$id_sesion."&curl=".$url2."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli3="http://do.convertapi.com/Web2Image?OutputFileName=PAG2_predis_8".$id_sesion."&curl=".$url3."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli4="http://do.convertapi.com/Web2Image?OutputFileName=PAG3_predis_8".$id_sesion."&curl=".$url4."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli5="http://do.convertapi.com/Web2Image?OutputFileName=PAG4_predis_8".$id_sesion."&curl=".$url5."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli6="http://do.convertapi.com/Web2Image?OutputFileName=PAG5_predis_8".$id_sesion."&curl=".$url6."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli7="http://do.convertapi.com/Web2Image?OutputFileName=PAG6_predis_8".$id_sesion."&curl=".$url7."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli8="http://do.convertapi.com/Web2Image?OutputFileName=PAG7_predis_8".$id_sesion."&curl=".$url8."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli9="http://do.convertapi.com/Web2Image?OutputFileName=PAG8_predis_8".$id_sesion."&curl=".$url9."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli10="http://do.convertapi.com/Web2Image?OutputFileName=PAG9_predis_8".$id_sesion."&curl=".$url10."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli11="http://do.convertapi.com/Web2Image?OutputFileName=PAG10_predis_8".$id_sesion."&curl=".$url11."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli12="http://do.convertapi.com/Web2Image?OutputFileName=PAG11_predis_8".$id_sesion."&curl=".$url12."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli13="http://do.convertapi.com/Web2Image?OutputFileName=PAG12_predis_8".$id_sesion."&curl=".$url13."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli14="http://do.convertapi.com/Web2Image?OutputFileName=PAG13_predis_8".$id_sesion."&curl=".$url14."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli15="http://do.convertapi.com/Web2Image?OutputFileName=PAG14_predis_8".$id_sesion."&curl=".$url15."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
$urlcli16="http://do.convertapi.com/Web2Image?OutputFileName=PAG15_predis_8".$id_sesion."&curl=".$url16."?&PageWidth=796&PageHeight=1123&ApiKey=855890385";
?>
<!DOCTYPE HTML>
<html>
<head>
                ...
                <div id="pagina-detalle">
                    <div class="col-lg-offset-0 col-md-offset-1 col-lg-12 col-md-11 col-xs-12">
                        <div id="wrap-detalle" class="col-lg-6 col-md-9 col-xs-12">
                            ...
                            <form action="predis_diseniar-16-paginas_confirmar.php" method="post" id="detalle-pedido" name="detalle-pedido" class="col-xs-12">
                                <?php
                                    $fecha = date('Y-m-j');
                                                    ...
                                                    /** * Verifica que una fecha esté dentro del rango de fechas establecidas * @param $start_date fecha de inicio * @param $end_date fecha final * @param $evaluame fecha a comparar * @return true si esta en el rango, false si no lo está */ function check_in_range($start_date, $end_date, $evaluame) { 
                                                        ...
                                                        <div class="hidden">
					                                        ...
					                                        <div class="col-sm-6 col-xs-12">
					                                            <p><strong>BULTOS: </strong><span id="bultos1">5 Cajas</span></p>
					                                        </div>
					                                        <div class="col-sm-6 col-xs-12">
    ...
    $(document).ready(function () { 
        ...
        $("#continuar").click(function() {
            ...
            if (cantVal == '') {
                ...
                else {dirfinal2 = $('#direccion_1').val();}
                $('#dirfinal').html(dirfinal2);
