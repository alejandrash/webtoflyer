            ...
            <div class="wrapper-prod-general">
                ...
                <div class="botonera-acciones col-lg-2 col-md-12 col-xs-12">
                    <ul>
                        ...
                        <li class="secundarias"><a class="active" href="#tablaResultados">&bull; ADMINISTRAR MARCAS</a></li>
                        <?php 
                        }
                        else {
                ...
                <div class="wrap-productos col-lg-10 col-md-12 col-xs-12">
                    ...
                    <div class="titular col-xs-12">
                        ...
                        <ul>
                            <li class="active"><a href="#">Insertar Marca</a></li>
                            <?php 
                            if ($niveluser != 'operador') {
                            ?>
                            <li><a href="#tablaResultados">Administrar Marcas</a></li>
                            <?php 
                            }
                            ?>
                        </ul>
                    ...
                    <div class="content-form col-xs-12">
                        <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 col-xs-offset-0 col-xs-12">
                            ...
                            <?php } ?>
                            <form class="form-inline" action="insertarmarca_procesar.php" method="post" id="insertarmarca" name="insertarmarca" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <p class="small"><strong><u>Requisitos</u>: Formato de imagen JPG/PNG, Resoluci&oacute;n 300dpi, Colores RGB<br>Dimensiones: Alto 4cm, Ancho proporcional, Tama&ntilde;o aprox 300 kb</strong></p>
                                    <div class="fotowrap">
                        ...
                        <?php 
                            $result_pr=mysql_query("select * from marcas ORDER BY nombre ASC");
                        ...
                        <form action="eliminarmarca_procesar.php" method="post" id="administrarmarca" name="administrarmarca">
                            <table border="0" cellpadding="0" cellspacing="0" class="dataTable" id="tablaResultados">
                                ...
                                <tr class="encabezado">
                                    ...
                                    ?>
                                    <th width="30" style="width:60px; background:none!important; cursor:default!important;">&nbsp;</th>
                                    <th width="30" style="width:60px; background:none!important; cursor:default!important;">&nbsp;</th>
                                    <?php  
                                    }
                                    ?>
                                ...
                                <tr class="<?php echo $stilo?>">
                                    ...
                                    <td><a href="modificarmarca.php?id_pub=<?php echo $row_pr['Id']?>"><img src="images/iconito-modificar.png" title="Modificar"></a></td>
                                    <?php 
                                    }
                                    else {
                                    ?>
                        ...
                        <?php
                                ...
                                echo("<p class='col-xs-12 error text-center'><br><br>No hay marcas disponibles.</p>");
                            }
                        ?>
                    </div>
                    <!-- Form end-->
