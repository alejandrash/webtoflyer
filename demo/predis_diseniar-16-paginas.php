    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"predis_tapa_".$_SESSION['ESTADO']})) {
            	if ($niveluser!='operador') {
	                $result_esta=mysql_query("select * from rating_productos WHERE cara='tapa' and tipo='16' AND actual='si' and predisenio='si'");
	                if($row_esta=mysql_fetch_array($result_esta)){
	                    //$delete_esta=mysql_query("delete from rating_productos WHERE cara='tapa' and tipo='16' AND actual='si' and predisenio='si'");
	                }
            	}
            	if ($niveluser=='operador') {
	                $result_esta=mysql_query("select * from rating_productos WHERE cara='tapa' and tipo='16' AND actual='si' and usuario='$usuario'");
	                if($row_esta=mysql_fetch_array($result_esta)){
	                    $delete_esta=mysql_query("delete from rating_productos WHERE cara='tapa' and tipo='16' AND actual='si'");
	                }
            	}
            }
            if (isset($_SESSION{"predis_archivo_contratapa_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag2_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag3_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?>  
            ...
            if (isset($_SESSION{"predis_archivo_pag4_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag5_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag6_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag7_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag8_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag9_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag10_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
                    $('.editar_partes #ed_10').removeClass('disabled');
            <?php 
                }   
            } 
            if (isset($_SESSION{"predis_archivo_pag11_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag12_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag13_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag14_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_archivo_pag15_".$_SESSION['ESTADO']})) { 
                if ($niveluser!='operador') {
            ?> 
            ...
            if (isset($_SESSION{"predis_tapa_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"predis_tapa_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_tapa').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
                       url: "predis_recuperartapa.php",
                       data: {
                            'content': content
                        },
                       success: function(data)
            ...
            $(".guardar").click(function(e) {
                    ...
                    <?php 
                    if (isset($_SESSION{"predis_archivo_tapa_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"predis_archivo_tapa_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                    var name = '<?php echo("flyer/html/FLYER_TAPA_".date('m-d-Y_hia').".html"); ?>';
                    <?php 
                    }
                    ?>
            ...
            $(".continuar").click(function(e) {
                    ...
                    $("#flyercontainer .cajaproducto .zona-cuota input").each(function() {
                        if ($(this).val() == '$0,00') {
                            controlPCuota = 1;
                        } 
                    });
                    ...
                    if (controlPCuota == 1) {
                        //hayerror = 1;
                        //alert("Complete la FORMA DE FINANCIACIÓN de todos los productos con financiación.");
                        //return false;
                    }
                    /* CONTROL PROMO PIE */
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#cargando').fadeOut();
                                    window.location.href = "predis_diseniar-16-paginas_contratapa.php";
                                }
                        });
                    }
            });
                ...
                <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div id="lateral" class="lateral col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-right">
                            <div class="row">
                                <div class="editar_partes paginas16">
                                    <ul>
                                        <li><a id="ed_tapa" class="disabled activada" href="predis_diseniar-16-paginas.php" title="EDITAR TAPA">TAPA</a></li>
                                        ...
                                        <li><a id="ed_10" class="disabled" href="predis_diseniar-16-paginas_9.php" title="EDITAR PAGINA 10"><strong>10</strong></a></li>
                    ...
                    <?php
                       /*VERIFICO SY TIENE FLYER SIN TERMINAR */
                        ...
                        /* CASA CENTRAL Y IDG */
                        if ($niveluser!='operador') {
	                        $result_fly=mysql_query("select * from predisenio WHERE tipo='16' and cara='tapa' ORDER BY Id DESC LIMIT 1");
	                        ...
	                        if ($hay == 1) {
	                            if (($row_fly['id_sesion']!=$id_sesion) || (!isset($_SESSION{"predis_tapa_".$_SESSION['ESTADO']}))) {
	                                ...
	                                <?php
	                                    echo('<div id="wrap-enviado" class="col-lg-8 col-md-8 col-sm-9 col-xs-12 eleccion"><br><br><p class="">El diseño de la revista prediseñada ya esta empezado y/o terminado. Queres modificarlo y/o continuarlo?</p><br><br> <a class="btn col-xs-3 col-xs-offset-2" href="predis_diseniar-16-paginas.php?contin=si" title="Click aqui para continuar el diseño"><img src="images/continuardis.jpg" class="img-responsive out" alt=""><img src="images/continuardis_over.jpg" class="img-responsive over" alt=""></a> <a class="comenzar btn col-xs-offset-2 col-xs-3" title="Click aqui para comenzar un nuevo diseño de revista" href="predis_diseniar-16-paginas.php?nuevo=si"><img src="images/nuevodis.jpg" class="img-responsive out" alt=""><img src="images/nuevodis_over.jpg" class="img-responsive over" alt=""></a></div>');
	                                }
	                                if (isset($_GET['nuevo'])) {
	                                    $result_fly=mysql_query("DELETE from predisenio WHERE tipo='16'");
	                                    $result_esta=mysql_query("select * from rating_productos WHERE tipo='16' and actual='si' AND predisenio='si'");
	                                   if ($row_esta=mysql_fetch_array($result_esta))
	                                   {
	                                        do {
	                                           $id = $row_esta['Id'];
	                                           ...
	                                           if ($orden == 0) {
	                                                ...
	                                                $result=mysql_query("UPDATE rating_productos set actual='no' WHERE tipo='16' AND predisenio='si'") or die(mysql_error());
	                                           }
	                                        } while ($row_esta=mysql_fetch_array($result_esta));
	                                    }
	                                    header("Location:predis_diseniar-16-paginas.php");
                                        ?>
                                        <script type="text/javascript">
                                            $(document).ready(function () {
                                        ...
                                        <div id="flyercontainer">
                                            <div id="tapa" class="wrap-flyer">
                                                <div class="aramis"><?php echo($row_user['cod_aramis']);?></div>
                                                ...
                                                <div class="grupoproductos col-xs-12">
                                                        <?php echo($cadena1.$cadena2);?><div class="row separador-central"><img style="width:100%;" src="images/diseniar/separador_gris-puntos.jpg" alt=""></div><?php echo($cadena3.$cadena4);?></div>
	                                ...
	                                if (isset($_GET['contin'])) {
	                                    ...
	                                    //TAPA
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='tapa' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $_SESSION['SESIONFLY']=$id_sesion_old;
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_tapa_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_tapa_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
	                                    }
	                                    //CONTRATAPA
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='contratapa' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_contratapa_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_contratapa_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_contratapa').removeClass('disabled');
	                                    ...
	                                    //PAGINA 2
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag2' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag2_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag2_".$_SESSION['ESTADO']} = $row_fly_otros['url']; 
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_2').removeClass('disabled');
	                                    ...
	                                    //PAGINA 3
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag3' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag3_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag3_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_3').removeClass('disabled');
	                                    ...
	                                    //PAGINA 4
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag4' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag4_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag4_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_4').removeClass('disabled');
	                                    ...
	                                    //PAGINA 5
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag5' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag5_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag5_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_5').removeClass('disabled');
	                                    ...
	                                    //PAGINA 6
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag6' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag6_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag6_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_6').removeClass('disabled');
	                                    ...
	                                    //PAGINA 7
	                                    $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag7' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag7_".$_SESSION['ESTADO']} = $html;
	                                        $_SESSION{"predis_archivo_pag7_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
	                                    ?>
	                                        <script type="text/javascript">
	                                            $('.editar_partes #ed_7').removeClass('disabled');
                                        ...
                                        //PAGINA 8
                                        $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag8' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag8_".$_SESSION['ESTADO']} = $html;
                                            $_SESSION{"predis_archivo_pag8_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
                                        ?>
                                            <script type="text/javascript">
                                                $('.editar_partes #ed_8').removeClass('disabled');
                                        ...
                                        //PAGINA 9
                                        $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag9' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag9_".$_SESSION['ESTADO']} = $html;
                                            $_SESSION{"predis_archivo_pag9_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
                                        ?>
                                            <script type="text/javascript">
                                                $('.editar_partes #ed_9').removeClass('disabled');
                                        ...
                                        //PAGINA 10
                                        $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag10' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag10_".$_SESSION['ESTADO']} = $html;
                                            $_SESSION{"predis_archivo_pag10_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
                                        ?>
                                            <script type="text/javascript">
                                                $('.editar_partes #ed_10').removeClass('disabled');
                                        ...
                                        //PAGINA 11
                                        $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag11' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag11_".$_SESSION['ESTADO']} = $html;
                                            $_SESSION{"predis_archivo_pag11_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
                                        ?>
                                            <script type="text/javascript">
                                                $('.editar_partes #ed_11').removeClass('disabled');
                                        ...
                                        //PAGINA 12
                                        $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag12' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag12_".$_SESSION['ESTADO']} = $html;
                                            $_SESSION{"predis_archivo_pag12_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
                                        ?>
                                            <script type="text/javascript">
                                                $('.editar_partes #ed_12').removeClass('disabled');
                                        ...
                                        //PAGINA 13
                                        $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag13' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag13_".$_SESSION['ESTADO']} = $html;
                                            $_SESSION{"predis_archivo_pag13_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
                                        ?>
                                            <script type="text/javascript">
                                                $('.editar_partes #ed_13').removeClass('disabled');
                                        ...
                                        //PAGINA 14
                                        $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag14' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag14_".$_SESSION['ESTADO']} = $html;
                                            $_SESSION{"predis_archivo_pag14_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
                                        ?>
                                            <script type="text/javascript">
                                                $('.editar_partes #ed_14').removeClass('disabled');
                                        ...
                                        //PAGINA 15
                                        $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='pag15' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag15_".$_SESSION['ESTADO']} = $html;
                                            $_SESSION{"predis_archivo_pag15_".$_SESSION['ESTADO']} = $row_fly_otros['url'];
                                            if ($niveluser!='operador'){
                                        ?>
                                            <script type="text/javascript">
                                                $('.editar_partes #ed_15').removeClass('disabled');
	                        ...
	                        ?>
	                                ...
	                                <!--START FLYER-->
	                                <div id="flyercontainer"><div id="tapa" class="wrap-flyer"><div class="aramis"><?php echo($row_user['cod_aramis']);?></div><div class="logomarquez col-xs-12"><img src="images/diseniar/cabecera-marquez.jpg" height="150" alt=""><div class="fecha"><span><?php echo($mescab." ".$aniocab);?></span></div></div><div class="promos col-xs-12"><img width="794" height="90" src="flyer/cabecera.jpg" alt=""></div><div class="grupoproductos col-xs-12"><?php echo($cadena1.$cadena2);?><div class="row separador-central"><img style="width:100%;" src="images/diseniar/separador_gris-puntos.jpg" alt=""></div><?php echo($cadena3.$cadena4);?></div><div href="#promopie" data-toggle="modal" class="promos col-xs-12 promospie" style="height:85px;">CLICK PARA SELECCIONAR UN BANNER...</div><div class="bordebottom" id="end"><div class="logopie"><img src="images/diseniar/logopie.png" width="167" alt=""></div><div class="legalespie">Los precios contado son v&aacute;lidos en efectivo, tarjeta de d&eacute;bito &oacute; tarjeta de cr&eacute;dito en 1 pago. Consulte por otros planes de financiaci&oacute;n. </div></div></div></div>
	                                <!--END FLYER-->
	                        <?php
	                        }
                   		}
                   		/* USUARIOS SOCIOS */
                   		if ($niveluser=='operador') {
                   			$result_fly=mysql_query("select * from flyers WHERE tipo='16predis' and cara='tapa' and terminado='no' and usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                   			$id_sesion = $_SESSION['SESIONFLY'];
	                        if ($row_fly=mysql_fetch_array($result_fly)) {
	                            $hay = 1;
	                        }
	                        ...
	                        if ($hay == 1) {
	                            if (($row_fly['id_sesion']!=$id_sesion) || (!isset($_SESSION{"predis_tapa_".$_SESSION['ESTADO']}))) {
	                                ...
	                                <?php
	                                    echo('<div id="wrap-enviado" class="col-lg-8 col-md-8 col-sm-9 col-xs-12 eleccion"><br><br><p class="titulo-pico">Dejaste una revista prediseñada sin terminar desde tu &uacute;ltima conexi&oacute;n a WTF.</p><br><br> <a class="btn col-xs-3 col-xs-offset-2" href="predis_diseniar-16-paginas.php?contin=si" title="Click aqui para continuar el diseño"><img src="images/continuardis.jpg" class="img-responsive out" alt=""><img src="images/continuardis_over.jpg" class="img-responsive over" alt=""></a> <a class="comenzar btn col-xs-offset-2 col-xs-3" title="Click aqui para comenzar un nuevo diseño de revista" href="predis_diseniar-16-paginas.php?nuevo=si"><img src="images/nuevodis.jpg" class="img-responsive out" alt=""><img src="images/nuevodis_over.jpg" class="img-responsive over" alt=""></a></div>');
	                                }
	                                if (isset($_GET['nuevo'])) {
	                                    $result_fly=mysql_query("DELETE from flyers WHERE tipo='16predis' and usuario='$usuario' and terminado='no'");
	                                    $result_esta=mysql_query("select * from rating_productos WHERE tipo='16' and actual='si' AND usuario='$usuario'");
	                                   if ($row_esta=mysql_fetch_array($result_esta))
	                                   {
	                                        do {
	                                           $id = $row_esta['Id'];
	                                           ...
	                                           if ($orden == 0) {
	                                                ...
	                                                $result=mysql_query("UPDATE rating_productos set actual='no' WHERE tipo='16' AND usuario='$usuario'") or die(mysql_error());
	                                           }
	                                        } while ($row_esta=mysql_fetch_array($result_esta));
	                                    }
	                                    header("Location:predis_diseniar-16-paginas.php");
	                                ...
	                                if (isset($_GET['contin'])) {
                                        ...
                                        <?php
	                                    //TAPA
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and cara='tapa' and terminado='no' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $_SESSION['SESIONFLY']=$id_sesion_old;
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and cara='tapa' and terminado='no' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_tapa_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_tapa_".$_SESSION['ESTADO']} = $html; 
                                            }
                                        }
	                                    //CONTRATAPA
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='contratapa' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_contratapa_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='contratapa' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_contratapa_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_contratapa_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 2
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag2' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag2_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag2' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag2_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag2_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 3
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag3' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag3_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag3' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag3_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag3_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 4
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag4' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag4_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag4' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag4_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag4_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 5
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag5' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag5_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag5' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag5_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag5_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 6
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag6' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag6_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag6' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2];
                                                $_SESSION{"predis_archivo_pag6_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag6_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

	                                    //PAGINA 7
	                                    $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag7' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
	                                    if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
	                                        $html = $row_fly_otros['grabado'];
	                                        $html=str_replace("*","'",$html);
	                                        $_SESSION{"predis_pag7_".$_SESSION['ESTADO']} = $html;
	                                    ...
	                                    <?php
	                                    	...
	                                    	$result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag7' ORDER BY Id DESC LIMIT 1");
	                                    	if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
		                                        $html = $row_fly_otros['grabado'];
		                                        $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag7_".$_SESSION['ESTADO']} = $url2;
		                                        $_SESSION{"predis_pag7_".$_SESSION['ESTADO']} = $html;
		                                    }
	                                    }

                                        //PAGINA 8
                                        $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag8' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag8_".$_SESSION['ESTADO']} = $html;
                                        ...
                                        <?php
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag8' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag8_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_pag8_".$_SESSION['ESTADO']} = $html;
                                            }
                                        }

                                        //PAGINA 9
                                        $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag9' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag9_".$_SESSION['ESTADO']} = $html;
                                        ...
                                        <?php
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag9' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag9_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_pag9_".$_SESSION['ESTADO']} = $html;
                                            }
                                        }

                                        //PAGINA 10
                                        $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag10' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag10_".$_SESSION['ESTADO']} = $html;
                                        ...
                                        <?php
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag10' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag10_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_pag10_".$_SESSION['ESTADO']} = $html;
                                            }
                                        }

                                        //PAGINA 11
                                        $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag11' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag11_".$_SESSION['ESTADO']} = $html;
                                        ...
                                        <?php
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag11' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag11_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_pag11_".$_SESSION['ESTADO']} = $html;
                                            }
                                        }

                                        //PAGINA 12
                                        $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag12' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag12_".$_SESSION['ESTADO']} = $html;
                                        ...
                                        <?php
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag12' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag12_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_pag12_".$_SESSION['ESTADO']} = $html;
                                            }
                                        }

                                        //PAGINA 13
                                        $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag13' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag13_".$_SESSION['ESTADO']} = $html;
                                        ...
                                        <?php
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag13' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag13_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_pag13_".$_SESSION['ESTADO']} = $html;
                                            }
                                        }

                                        //PAGINA 14
                                        $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag14' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag14_".$_SESSION['ESTADO']} = $html;
                                        ...
                                        <?php
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag14' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag14_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_pag14_".$_SESSION['ESTADO']} = $html;
                                            }
                                        }

                                        //PAGINA 15
                                        $result_fly_otros=mysql_query("select * from flyers WHERE tipo='16predis' and terminado='no' and cara='pag15' AND usuario='$usuario' ORDER BY Id DESC LIMIT 1");
                                        if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                            $html = $row_fly_otros['grabado'];
                                            $html=str_replace("*","'",$html);
                                            $_SESSION{"predis_pag15_".$_SESSION['ESTADO']} = $html;
                                        ...
                                        <?php
                                            ...
                                            $result_fly_otros=mysql_query("select * from predisenio WHERE tipo='16' and terminado='no' and cara='pag15' ORDER BY Id DESC LIMIT 1");
                                            if($row_fly_otros=mysql_fetch_array($result_fly_otros)) {
                                                $html = $row_fly_otros['grabado'];
                                                $html=str_replace("*","'",$html);
                                                $url = explode("/", $row_fly_otros['url']);
                                                $url2 = "flyer/html/".$iduser."_".$fechaurl."_".$url[2]; 
                                                $_SESSION{"predis_archivo_pag15_".$_SESSION['ESTADO']} = $url2;
                                                $_SESSION{"predis_pag15_".$_SESSION['ESTADO']} = $html;
                                            }
                                        }
	                                ?>
	                                ...
	                                <div id="flyercontainer">
	                                    <div id="tapa" class="wrap-flyer">
	                                        ...
	                                        <div class="promos col-xs-12"><img width="794" height="90" src="flyer/cabecera.jpg" alt=""></div>
	                                        <div class="grupoproductos col-xs-12">
	                                                <?php echo($cadena1.$cadena2);?><div class="row separador-central"><img style="width:100%;" src="images/diseniar/separador_gris-puntos.jpg" alt=""></div><?php echo($cadena3.$cadena4);?></div><div href="#promopie" data-toggle="modal" class="promos col-xs-12 promospie" style="height:85px;">CLICK PARA SELECCIONAR UN BANNER...</div><div class="bordebottom" id="end"><div class="logopie"><img src="images/diseniar/logopie.png" width="167" alt=""></div><div class="legalespie">Los precios contado son v&aacute;lidos en efectivo, tarjeta de d&eacute;bito &oacute; tarjeta de cr&eacute;dito en 1 pago. Consulte por otros planes de financiaci&oacute;n. </div></div></div></div>
	                                <!--END FLYER-->
	                                ...
	                                <!--START FLYER-->
	                                <div id="flyercontainer"><div id="tapa" class="wrap-flyer"><div class="aramis"><?php echo($row_user['cod_aramis']);?></div><div class="logomarquez col-xs-12"><img src="images/diseniar/cabecera-marquez.jng" height="150" alt=""><div class="fecha"><span><?php echo($mescab." ".$aniocab);?></span></div></div><div class="promos col-xs-12"><img width="794" height="90" src="flyer/cabecera.jpg" alt=""></div><div class="grupoproductos col-xs-12"><?php echo($cadena1.$cadena2);?><div class="row separador-central"><img style="width:100%;" src="images/diseniar/separador_gris-puntos.jpg" alt=""></div><?php echo($cadena3.$cadena4);?></div><div href="#promopie" data-toggle="modal" class="promos col-xs-12 promospie" style="height:85px;">CLICK PARA SELECCIONAR UN BANNER...</div><div class="bordebottom" id="end"><div class="logopie"><img src="images/diseniar/logopie.png" width="167" alt=""></div><div class="legalespie">Los precios contado son v&aacute;lidos en efectivo, tarjeta de d&eacute;bito &oacute; tarjeta de cr&eacute;dito en 1 pago. Consulte por otros planes de financiaci&oacute;n. </div></div></div></div>
	                                <!--END FLYER-->
	                            <?php }
	                        }
                                ...
                                ?>
                                                <script type="text/javascript">
                                                    ...
                                                    $.ajax({
                                                       ...
                                                       url: "predis_recuperartapa.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_tapa_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                                           $("#editor2").html(data); 
                                                           $('#editor2 .wrap-flyer .quitar, #editor2 .wrap-flyer .eliminar-sda, #editor2 .wrap-flyer #agregar-sda img, #editor2 .wrap-flyer .frases, #editor2 .wrap-flyer .selecucarda span, #editor2 .wrap-flyer .agregartachado, #editor2 .wrap-flyer .quitartachado').remove(); 
                                                           var sesi = $("#editor").html();
                                                           var sesi2 = $("#editor2").html();
                                                            var fly = sesi2.replace(/images/g, "../../images");
                                                            fly = fly.replace(/"flyer/g, '"../../flyer');
                                                            $.ajax({
                                                                    type: "POST",
                                                                    dataType : "html",
                                                                    url: "<?php echo($urlCreate);?>",
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperar_contratapa.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_contratapa_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                                           $("#editor2").html(data); 
                                                           $('#editor2 .wrap-flyer .quitar, #editor2 .wrap-flyer .eliminar-sda, #editor2 .wrap-flyer #agregar-sda img, #editor2 .wrap-flyer .frases, #editor2 .wrap-flyer .selecucarda span, #editor2 .wrap-flyer .agregartachado, #editor2 .wrap-flyer .quitartachado, #editor2 .wrap-flyer .direccion_elegir .form-control, #editor2 .wrap-flyer .direccion_elegir i.fa-minus-circle, #editor2 .wrap-flyer .direccion #agregarsuc').remove(); 
                                                           var sesi = $("#editor").html();
                                                           var sesi2 = $("#editor2").html();
                                                            var fly = sesi2.replace(/images/g, "../../images");
                                                            fly = fly.replace(/"flyer/g, '"../../flyer');
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag2.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag2_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag3.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag3_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag4.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag4_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
		                                    ...
		                                    ?>
		                                        <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag5.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag5_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
		                                    ...
		                                    ?>
		                                        <script type="text/javascript"> 
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag6.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag6_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag7.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag7_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag8.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag8_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag9.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag9_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       ...
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag10_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag11.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag11_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag12.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag12_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag13.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag13_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag14.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag14_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
                                            ...
                                            ?>
                                                <script type="text/javascript">
                                                    $.ajax({
                                                       type: "POST",
                                                       dataType: "html",
                                                       url: "predis_recuperarpag15.php",
                                                       data: {
                                                            'content': '<?php $_SESSION{"predis_pag15_".$_SESSION['ESTADO']}; ?>'
                                                        },
                                                       success: function(data)
                                                       {
                                                           $("#editor").html(data); 
    ...
    <div class="col-xs-12 contenedor">
        ...
        <ul>
            <li>
                ...
                <div class="respuesta">
                    Ingresá en la sección DISEÑAR FLYER y elegí el formato que querés (por ejemplo: Revista de 8 páginas). Una vez hecho esto necesitas agregar tu primer producto a la revista, para esto deberáshacer click en cualquiera de los módulos que dicen “Haz click para agregar un producto”. La página te dirigirá a la base de productos para que puedas elegir el que querés publicar. Los productos están ordenados por categorías para que los puedas encontrar fácilmente. Además contás con un buscador por nombre, marca o modelo. Una vez seleccionado el producto, éste se colocará automáticamente en la plantilla de la revista. Debés continuar agregando productos hasta completar todos los módulos.
