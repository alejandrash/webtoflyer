    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"pag5_8_".$_SESSION['ESTADO']})) {
                $result_esta=mysql_query("select * from rating_productos WHERE usuario='$usuario' and cara='pag5' and tipo='8' and actual='si'");
                if($row_esta=mysql_fetch_array($result_esta)){
                    $delete_esta=mysql_query("DELETE FROM rating_productos WHERE usuario='$usuario' and cara='pag5' and tipo='8' and actual='si'");
                }
            }
            ...
            if (isset($_SESSION{"pag5_8_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"pag5_8_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_5').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
                       url: "recuperarpag5_8.php",
                       data: {
                            'content': content
                        },
                       success: function(data)
            ...
            $(".guardar").click(function(e) { 
                    ...
                    <?php 
                    if (isset($_SESSION{"archivo_pag5_8_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"archivo_pag5_8_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
            ...
            $(".continuar").click(function(e) {
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#cargando').fadeOut();
                                    window.location.href = "diseniar-8-paginas_5.php";
                                }
                        });
                    }
                    return false;
                            ...
                            <div class="row">
                                <div class="editar_partes">
                                    <ul>
                                        ...
                                        <li><a id="ed_5" class="disabled activada" href="diseniar-8-paginas_4.php" title="EDITAR PAGINA 5"><strong>5</strong></a></li>
