    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"predis_pag3_".$_SESSION['ESTADO']})) {
                if ($niveluser!='operador') {
                    $result_esta=mysql_query("select * from rating_productos WHERE cara='pag3' and tipo='16' AND actual='si' and predisenio='si'");
                    if($row_esta=mysql_fetch_array($result_esta)){
                        $delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='pag3' and tipo='16' AND actual='si' and predisenio='si'");
                    }
                }
                if ($niveluser=='operador') {
                    $result_esta=mysql_query("select * from rating_productos WHERE cara='pag3' and tipo='16' AND actual='si' and usuario='$usuario'");
                    if($row_esta=mysql_fetch_array($result_esta)){
                        $delete_esta=mysql_query("DELETE FROM rating_productos WHERE cara='pag3' and tipo='16' AND actual='si'");
                    }
                }
            }
            ...
            if (isset($_SESSION{"predis_pag3_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"predis_pag3_".$_SESSION['ESTADO']}; ?>';
            ...
            $(".guardar").click(function(e) {
                    ...
                    if (isset($_SESSION{"predis_archivo_pag3_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"predis_archivo_pag3_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
            ...
            $(".continuar").click(function(e) {
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#cargando').fadeOut();
                                    window.location.href = "predis_diseniar-16-paginas_3.php";
                                }
                        });
                    }
            });
                            ...
                            <div class="row">
                                <div class="editar_partes paginas16">
                                    <ul>
                                        ...
                                        <li><a id="ed_3" class="disabled activada" href="predis_diseniar-16-paginas_2.php" title="EDITAR PAGINA 3"><strong>3</strong></a></li>
