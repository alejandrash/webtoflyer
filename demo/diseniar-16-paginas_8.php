...
?>
<?php
    $result_traecantidad=mysql_query("select * from banners_flyer WHERE cara='pag9' AND mes='$mesbanner'");
    $valor = 0;
    $valortotal = 0;
    $maximoprod = 12;
...
// CONSULTA BLOQUEO DE MARCAS
    $result_bloqueo=mysql_query("select marca, cantidad, nombre, logo from bloqueo INNER JOIN marcas ON marcas.Id=bloqueo.marca WHERE cara='pag9' order by fecha desc");
?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    function cargarLegales() {
        ...
        $(document).ready(function () {
            ...
            if (!isset($_SESSION{"pag9_".$_SESSION['ESTADO']})) {
                $result_esta=mysql_query("select * from rating_productos WHERE usuario='$usuario' and cara='pag9' and tipo='16' and actual='si'");
                if($row_esta=mysql_fetch_array($result_esta)){
                    $delete_esta=mysql_query("DELETE FROM rating_productos WHERE usuario='$usuario' and cara='pag9' and tipo='16' and actual='si'");
                }
            }
            ...
            if (isset($_SESSION{"pag9_".$_SESSION['ESTADO']})) { ?>
                ...
                var content = '<?php $_SESSION{"pag9_".$_SESSION['ESTADO']}; ?>';
                $('.editar_partes #ed_pag9').removeClass('disabled');
                $.ajax({
                       type: "POST",
                       dataType: "html",
                       url: "recuperarpag9.php",
                       data: {
                            'content': content
                        },
                       success: function(data)
            ...
            $(".guardar").click(function(e) { 
                    ...
                    <?php 
                    if (isset($_SESSION{"archivo_pag9_".$_SESSION['ESTADO']})) { ?>
                        var name = '<?php echo($_SESSION{"archivo_pag9_".$_SESSION['ESTADO']}); ?>';
                    <?php 
                    }
                    else {
                    ?>
                    var name = '<?php echo("flyer/html/FLYER_pag9_".date('m-d-Y_hia').".html"); ?>';
                    <?php 
                    }
                    ?>
            ...
            $(".continuar").click(function(e) {
                    ...
                    if (hayerror == 0) {
                        ...
                        $.ajax({
                                ...
                                success: function(data){
                                    $('#cargando').fadeOut();
                                    window.location.href = "diseniar-16-paginas_9.php";
                                }
                        });
                    }
                    return false;
	   ...
	   <div class="inner-content">
		<!-- header-starts -->
           ...
           <div class="col-xs-12 titulogris">
                <p class="col-xs-12"><img src="images/titulos/diseniar.png" class="img-responsive" alt=""> DISEÑAR - Editando P&Aacute;GINA 9</p>
            </div>
			<!-- Diseniar start-->
                            ...
                            <div class="row">
                                <div class="editar_partes paginas16">
                                    <ul>
                                        ...
                                        <li><a id="ed_9" class="disabled activada" href="diseniar-16-paginas_8.php" title="EDITAR PAGINA 9"><strong>9</strong></a></li>
                        ...
                        <!--START FLYER-->
                                <div id="flyercontainer">
                                    <div id="pag9" class="wrap-flyer">
                                        ...
                                        <div class="bordebottom" id="end"><div class="legalespie">Los precios contado son v&aacute;lidos en efectivo, tarjeta de d&eacute;bito &oacute; tarjeta de cr&eacute;dito en 1 pago. Consulte por otros planes de financiaci&oacute;n. </div><div class="logopie"><span>9</span></div></div>
